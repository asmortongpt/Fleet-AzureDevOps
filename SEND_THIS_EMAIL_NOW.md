...
**Attach File:** `/Users/andrewmorton/Documents/GitHub/Fleet/deployment/vendor-access/himanshu-access-package.tar.gz`

---

## EMAIL BODY (Copy Everything Below the Line)
...
## ✅ BEFORE YOU SEND - ADD TEAM TO AZURE DEVOPS

You MUST add team members to Azure DevOps first:

1. Go to: https://dev.azure.com/CapitalTechAlliance/_settings/policy
2. Enable "External guest access"
3. Go to: https://dev.azure.com/CapitalTechAlliance/_settings/users
4. Add these users (Basic access, Contributors group):
   - Krishna@capitaltechalliance.com
   - Danny@capitaltechalliance.com
   - Manit@capitaltechalliance.com
   - Himanshu.badola.proff@gmail.com

**Detailed steps:** See `AZURE_DEVOPS_TEAM_SETUP.md`
...
3. Add recipients and attachment
4. Send!

**File Location:** `/Users/andrewmorton/Documents/GitHub/Fleet/deployment/vendor-access/himanshu-access-package.tar.gz`
