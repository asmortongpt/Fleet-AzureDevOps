        ...
        {activeView === '3d' && (
          <div className="h-[600px] rounded-md overflow-hidden bg-[#111]">
            ...
            <button
              ...
              className="absolute bottom-6 right-6 w-16 h-16 bg-emerald-600 rounded-full shadow-sm flex items-center justify-center hover:bg-emerald-700 transition-colors"
            >
