...
export class SentryErrorBoundary extends Component<Props, State> {
    ...
    return (
      <div className="mt-2 p-2 bg-white/[0.03] dark:bg-[#111113] rounded-lg">
        <div className="space-y-2">
          <div>
            <h4 className="font-semibold text-sm text-white/40 dark:text-white/60">
              Error Message:
            </h4>
          ...
          {import.meta.env.DEV && error.stack && (
            <div>
              ...
              <pre className="text-xs text-white/70 dark:text-white/40 overflow-x-auto whitespace-pre-wrap font-mono">
                {error.stack}
              </pre>
            </div>
          )}
          ...
          {this.state.eventId && (
            <div>
              ...
              <p className="text-xs text-white/70 dark:text-white/40 font-mono">
                {this.state.eventId}
              </p>
            </div>
          )}
  ...
  render() {
    ...
    if (level === 'page') {
      // Full page error
      return (
        <div className="min-h-screen flex items-center justify-center p-2 bg-white/[0.03] dark:bg-[#09090b]">
      ...
      return (
        <div className="p-2 border border-red-200 dark:border-red-800 rounded-lg bg-red-50 dark:bg-red-900/20">
          ...
          <p className="mt-1 text-sm text-white/70 dark:text-white/40">
