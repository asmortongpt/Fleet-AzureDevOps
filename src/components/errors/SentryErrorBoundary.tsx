        ...
        <div className="space-y-2">
          ...
          {import.meta.env.DEV && error.stack && (
            <div>
              ...
              <pre className="text-xs text-slate-700 dark:text-gray-700 overflow-x-auto whitespace-pre-wrap font-mono">
                {error.stack}
              </pre>
            </div>
          )}
          ...
          {this.state.eventId && (
            <div>
              ...
              <p className="text-xs text-slate-700 dark:text-gray-700 font-mono">
                {this.state.eventId}
              </p>
            </div>
          )}
    ...
    if (level === 'page') {
      ...
      return (
        <div className="p-2 border border-red-200 dark:border-red-800 rounded-lg bg-red-50 dark:bg-red-900/20">
          ...
          <p className="mt-1 text-sm text-slate-700 dark:text-gray-700">
