                  ...
                  {stats && (
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex justify-between">
                        <span className="text-[var(--text-tertiary)]">Avg Response</span>
                ...
                return (
                  <div className="space-y-2">
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        {stats.history.slice(-5).reverse().map((check) => (
                          <div
                            key={check.timestamp}
                            className="flex items-center justify-between p-2 bg-white dark:bg-[var(--surface-3)] rounded"
                          >
                            <div className="flex items-center gap-2">
                              <div
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <div className="p-3 bg-white dark:bg-[var(--surface-3)] rounded">
                        <div className="text-sm text-[var(--text-tertiary)]">Total Checks</div>
                        <div className="text-sm font-bold">{stats.totalChecks}</div>
                      </div>
                      <div className="p-3 bg-white dark:bg-[var(--surface-3)] rounded">
                        <div className="text-sm text-[var(--text-tertiary)]">Failed Checks</div>
                      ...
                      <div className="p-3 bg-white dark:bg-[var(--surface-3)] rounded">
                        <div className="text-sm text-[var(--text-tertiary)]">Last Check</div>
