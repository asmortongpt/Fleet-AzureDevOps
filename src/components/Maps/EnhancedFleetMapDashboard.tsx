...
export function EnhancedFleetMapDashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a]">
      {/* Header */}
      <motion.div
        className="border-b border-white/[0.04] bg-[#0e0e0e] sticky top-0 z-10"
        ...
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-white/60">Real-time vehicle monitoring and analytics</p>
            </div>
          </div>
      ...
      >
        {stats.map((stat) => {
          ...
          return (
            <motion.div
              key={stat.label}
              className="rounded-xl p-4 border border-white/[0.04] bg-[#111111] hover:border-white/[0.08] transition-colors"
              whileHover={{ y: -4 }}
      ...
      {/* Footer Info */}
      <motion.div
        className="border-t border-white/[0.04] bg-[#0e0e0e] py-6"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              <p className="text-xs uppercase tracking-wider font-semibold text-white/35 mb-1">Status</p>
            ...
            <div>
              <p className="text-xs uppercase tracking-wider font-semibold text-white/35 mb-1">Last Updated</p>
              <p>Just now • Real-time sync enabled</p>
            </div>
            <div>
              <p className="text-xs uppercase tracking-wider font-semibold text-white/35 mb-1">Data</p>
