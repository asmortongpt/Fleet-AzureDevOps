...
export const LiveFleetMap: React.FC<LiveFleetMapProps> = ({
  ...
  if (isLoading) {
    return (
      <div className="w-full h-full p-2 space-y-3 bg-[#0a0a0a]">
  ...
  if (error) {
    return (
      <div className="flex items-center justify-center w-full h-full bg-[#0a0a0a] p-3">
  ...
  if (!filteredVehicles || filteredVehicles.length === 0) {
    return (
      <div className="flex items-center justify-center w-full h-full bg-[#0a0a0a] p-3">
        <div className="text-center max-w-md p-3 bg-[#1a1a1a]/60 border border-white/[0.04] rounded-lg">
    ...
    <div className={`relative w-full h-full ${className}`}>
      ...
      <div className="absolute top-4 right-4 z-10">
        <Button
          ...
          variant="outline"
          size="sm"
          className="bg-[#111111] border-white/[0.04] hover:bg-[#161616] text-white/60"
        >
          <RefreshCw className="w-4 h-4 mr-2" />
          Refresh
        </Button>
