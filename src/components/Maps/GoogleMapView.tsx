...
const LoadingComponent: React.FC = () => (
  <div className="flex items-center justify-center w-full h-full bg-[var(--surface-0)]">
...
const ErrorComponent: React.FC<{ error: Error }> = ({ error }) => (
  <div className="flex items-center justify-center w-full h-full bg-[var(--surface-0)]">
    <div className="text-center max-w-md p-3 bg-red-500/10 border border-red-500/20 rounded-lg">
      ...
      <p className="text-sm text-[var(--text-secondary)] mb-2">{error.message}</p>
...
export const GoogleMapView: React.FC<GoogleMapViewProps> = ({
  ...
  return (
    <div className={`relative w-full h-full ${className}`}>
      ...
      <div className="absolute top-4 left-4 bg-[var(--surface-2)] rounded-lg p-3 space-y-2 border border-[var(--border-subtle)]">
