  ...
  return (
    <div className="min-h-screen bg-slate-900 p-6">
      ...
      <div className="mb-6">
        ...
        <p className="text-slate-400">System Management & Compliance Oversight</p>
      </div>

      {/* System Health Summary */}
      <Card className={cn(
        "backdrop-blur-xl p-6 mb-6",
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="bg-slate-900/50 rounded-lg p-4 border border-slate-700">
            ...
            <p className="text-2xl font-bold text-white">{systemHealth.api_uptime}%</p>
          </div>
          ...
          <div className="bg-slate-900/50 rounded-lg p-4 border border-slate-700">
            ...
            <p className="text-2xl font-bold text-white">{systemHealth.api_error_rate}%</p>
          </div>
          ...
          <div className="bg-slate-900/50 rounded-lg p-4 border border-slate-700">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-slate-300 text-sm">DB Connections</span>
            </div>
            <p className="text-2xl font-bold text-white">{systemHealth.database_connections}</p>
          </div>
          ...
          <div className="bg-slate-900/50 rounded-lg p-4 border border-slate-700">
            ...
            <p className="text-2xl font-bold text-white">{systemHealth.avg_response_time_ms}ms</p>
          </div>
        </div>
      </Card>
          ...
          <div className="space-y-3">
            ...
            <div className="bg-slate-900/50 rounded-lg p-4 border border-slate-700">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-3xl font-bold text-white">{userStats.total_users}</span>
              </div>
            ...
            >
              <div className="flex items-center justify-between mb-1">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-slate-300 text-sm">Failed Logins (24h)</span>
                </div>
            ...
            >
              <div className="flex items-center justify-between mb-1">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-slate-300 text-sm">Compliance Violations</span>
                </div>
                <span className="text-2xl font-bold text-white">
            ...
            <div className="bg-slate-900/50 rounded-lg p-4 border border-slate-700">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-slate-300 text-sm">Pending Audits</span>
                </div>
                <span className="text-2xl font-bold text-white">
      ...
      <Card className="bg-slate-800/50 backdrop-blur-xl border-slate-700 p-6 mt-6">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-xl font-bold text-white">Reports & Data Export</h2>
        </div>
