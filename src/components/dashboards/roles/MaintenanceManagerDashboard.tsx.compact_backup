    ...
    <div className="min-h-screen bg-slate-900 p-6">
      ...
      <div className="mb-6 flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-400">Work Order Management & Preventive Maintenance</p>
        </div>
        <Button
      ...
      {/* Work Queue Summary */}
      <Card className="bg-slate-800/50 backdrop-blur-xl border-amber-500/30 p-6 mb-6">
        <div className="flex items-center gap-2 mb-4">
          <Wrench className="w-6 h-6 text-amber-400" />
          <h2 className="text-xl font-bold text-white">Work Queue</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          >
            <div className="flex items-start justify-between mb-2">
              <ListChecks className="w-8 h-8 text-red-400" />
              <span className="text-3xl font-black text-white">{workOrderStats.open}</span>
            </div>
          ...
          >
            <div className="flex items-start justify-between mb-2">
              ...
              <span className="text-3xl font-black text-white">{workOrderStats.in_progress}</span>
            </div>
          ...
          >
            <div className="flex items-start justify-between mb-2">
              ...
              <span className="text-3xl font-black text-white">{workOrderStats.completed_this_week}</span>
            </div>
          ...
          >
            <div className="flex items-start justify-between mb-2">
              ...
              <span className="text-3xl font-black text-white">{workOrderStats.avg_repair_time_hours}</span>
            </div>
              ...
              >
                <div className="flex items-start justify-between mb-2">
                  <div className="flex items-center gap-3">
                    <CarSimple className="w-6 h-6 text-red-400" />
                    <div>
        ...
        <div className="space-y-6">
          ...
          <Card className="bg-slate-800/50 backdrop-blur-xl border-slate-700 p-6">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="text-xl font-bold text-white">Upcoming Maintenance (Next 7 Days)</h2>
            </div>
          ...
          <Card className="bg-slate-800/50 backdrop-blur-xl border-slate-700 p-6">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="text-xl font-bold text-white">Parts Inventory Status</h2>
            </div>
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-slate-300">Below Reorder Level</span>
                  </div>
