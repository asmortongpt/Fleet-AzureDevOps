  ...
  return (
    <div className="min-h-screen bg-slate-900 p-6">
      ...
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-white mb-2">Dispatch Console</h1>
          <p className="text-slate-400">Real-Time Operations & Coordination</p>
        </div>
        <Button
      ...
      <Card className="bg-slate-800/50 backdrop-blur-xl border-cyan-500/30 p-6 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          >
            <div className="flex items-start justify-between mb-2">
              <CarSimple className="w-8 h-8 text-cyan-400" />
              <span className="text-3xl font-black text-white">{operationStats.active_trips}</span>
            </div>
          ...
          >
            <div className="flex items-start justify-between mb-2">
              <MapTrifold className="w-8 h-8 text-blue-400" />
              <span className="text-3xl font-black text-white">{operationStats.en_route}</span>
            </div>
          ...
          >
            <div className="flex items-start justify-between mb-2">
              ...
              <span className="text-3xl font-black text-white">{operationStats.delayed}</span>
            </div>
          ...
          >
            <div className="flex items-start justify-between mb-2">
              ...
              <span className="text-3xl font-black text-white">{operationStats.completed_today}</span>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Live Fleet Map */}
        <Card className="lg:col-span-2 bg-slate-800/50 backdrop-blur-xl border-slate-700 p-6">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              <MapTrifold className="w-6 h-6 text-cyan-400" />
          ...
          {/* Map Placeholder */}
          <div className="bg-slate-900/50 rounded-xl border border-slate-700 aspect-video flex items-center justify-center mb-4">
      ...
      {/* Dispatch Channels */}
      <Card className="bg-slate-800/50 backdrop-blur-xl border-slate-700 p-6 mt-6">
        <div className="flex items-center gap-2 mb-4">
          <Radio className="w-6 h-6 text-violet-400" />
          <h2 className="text-xl font-bold text-white">Active Dispatch Channels</h2>
        </div>
