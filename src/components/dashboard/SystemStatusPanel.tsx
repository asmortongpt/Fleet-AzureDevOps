...
export function SystemStatusPanel({
  ...
  const getStatusColor = (status: 'connected' | 'disconnected' | 'error' | 'healthy' | 'degraded' | 'down') => {
    switch (status) {
      ...
      default:
        return 'text-[var(--text-tertiary)] dark:text-[var(--text-tertiary)]'
    }
  }
                        ...
                        <Circle
                          className={`w-1.5 h-1.5 flex-shrink-0 ${
                            emulator.status === 'connected'
                              ...
                              : 'fill-white/30 text-[var(--text-tertiary)]'
                          }`}
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    {emulator.status === 'connected' ? (
                      <Button
                        ...
                        aria-label={`Stop ${emulator.name} emulator`}
                      >
                      ...
                      <Button
                        ...
                        aria-label={`Start ${emulator.name} emulator`}
                      >
