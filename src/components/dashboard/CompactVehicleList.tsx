...
export function CompactVehicleList({
  ...
  const getStatusColor = (status: Vehicle["status"]) => {
    const colors: Record<string, string> = {
      ...
      idle: "bg-white/[0.05] text-[var(--text-tertiary)] border-[var(--border-default)] dark:bg-[var(--surface-3)] dark:text-[var(--text-tertiary)] dark:border-[var(--border-default)]",
      ...
      offline: "bg-white/[0.05] text-[var(--text-tertiary)] border-[var(--border-default)] dark:bg-[var(--surface-3)] dark:text-[var(--text-tertiary)] dark:border-[var(--border-default)]",
      ...
      retired: "bg-white/[0.05] text-[var(--text-tertiary)] border-[var(--border-default)] dark:bg-[var(--surface-3)] dark:text-[var(--text-tertiary)] dark:border-[var(--border-default)]",
    }
...
export function CompactVehicleListMini({
  ...
  const getStatusColor = (status: Vehicle["status"]) => {
    const colors: Record<string, string> = {
      ...
      idle: "text-[var(--text-tertiary)] dark:text-[var(--text-tertiary)]",
      charging: "text-emerald-800 dark:text-emerald-700",
      service: "text-amber-600 dark:text-amber-400",
      emergency: "text-red-600 dark:text-red-400",
      offline: "text-[var(--text-tertiary)] dark:text-[var(--text-tertiary)]",
      ...
      retired: "text-[var(--text-tertiary)] dark:text-[var(--text-tertiary)]",
    }
    return colors[status] || colors.offline
  }
