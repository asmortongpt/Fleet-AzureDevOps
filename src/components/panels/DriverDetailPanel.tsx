...
export function DriverDetailPanel({ driver, onClose, vehicles = [] }: DriverDetailPanelProps) {
    ...
    return (
            <div
                className="absolute right-4 top-20 bottom-8 w-[400px] bg-[#0e0e0e] border border-white/[0.04] rounded-lg overflow-hidden flex flex-col z-40"
            >
                {/* Header / Profile Cover */}
                <div className="relative h-32 bg-[#111111] shrink-0">
                    ...
                    <div className="absolute -bottom-10 left-6">
                        <div className="w-20 h-20 rounded-full border-4 border-white/[0.04] bg-white/[0.06] flex items-center justify-center text-sm font-bold text-white/60">
                ...
                <div className="pt-12 px-3 pb-3 flex-1 flex flex-col overflow-hidden">
                    ...
                    <div className="grid grid-cols-3 gap-2 mt-3 mb-3">
                        <div className="bg-white/[0.04] p-3 rounded-md border border-white/[0.04] text-center">
                            <div className={`text-base font-bold ${driver.safetyScore >= 90 ? 'text-green-600' : 'text-amber-600'}`}>
                                {driver.safetyScore}
                            </div>
                            <div className="text-[10px] uppercase font-bold text-white/60 mt-0.5">Safety</div>
                        </div>
                        <div className="bg-white/[0.04] p-3 rounded-md border border-white/[0.04] text-center">
                            <div className="text-base font-bold text-white/60">
                                4.9
                            </div>
                            <div className="text-[10px] uppercase font-bold text-white/60 mt-0.5">Rating</div>
                        </div>
                        <div className="bg-white/[0.04] p-3 rounded-md border border-white/[0.04] text-center">
                            <div className="text-base font-bold text-emerald-400">
                                98%
                            </div>
                            <div className="text-[10px] uppercase font-bold text-white/60 mt-0.5">On-Time</div>
                        </div>
                    </div>
                        ...
                        <ScrollArea className="flex-1 -mx-3 px-3">
                            <TabsContent value="overview" className="space-y-2 mt-0">
                                ...
                                <div className="space-y-3">
                                    <h4 className="text-xs font-bold text-white/60 uppercase tracking-wider">Current Status</h4>
                                    <div className="flex items-center justify-between p-3 bg-[#111111] border border-white/[0.04] rounded-md ">
                                        <div className="flex items-center gap-3">
                                            <Activity className="w-3 h-3 text-emerald-400" />
                                            <div>
                                                <div className="font-semibold text-sm">{formatEnum(driver.status)}</div>
                                                <div className="text-xs text-white/60">Since 08:00 AM</div>
                                            </div>
                                        </div>
                                ...
                                {/* assigned Vehicle */}
                                <div className="space-y-3">
                                    <h4 className="text-xs font-bold text-white/60 uppercase tracking-wider">Assigned Vehicle</h4>
                                    {assignment ? (
                                        <div className="p-3 bg-[#111111] border border-white/[0.04] rounded-md  hover:border-emerald-500/50 transition-colors cursor-pointer group">
                                            <div className="flex justify-between items-start">
                                                <div className="flex gap-3">
                                                    <div className="w-10 h-8 bg-white/[0.04] rounded-lg flex items-center justify-center">
                                                        <Truck className="w-3 h-3 text-white/60" />
                                                    </div>
                                                    <div>
                                        ...
                                        <div className="text-center p-3 border-2 border-dashed border-white/[0.04] rounded-md">
                                            <p className="text-sm text-white/60 mb-2">No vehicle currently assigned</p>
                                ...
                                {/* Licenses */}
                                <div className="space-y-3">
                                    <h4 className="text-xs font-bold text-white/60 uppercase tracking-wider">Compliance</h4>
                                    <div className="p-3 bg-white/[0.04] rounded-lg border border-white/[0.04] flex justify-between items-center">
                                        <div className="flex items-center gap-3">
                                            <FileCheck className="w-4 h-4 text-white/60" />
                                            <span className="text-sm font-medium">Commercial License</span>
                                        </div>
                                        <span className="text-xs text-white/60">Exp: {driver.licenseExpiry}</span>
                                    </div>
                                </div>
                            </TabsContent>
                            ...
                            <TabsContent value="activity" className="mt-0">
                                <div className="space-y-2">
                                    {recentActivity.map((item) => (
                                        <div key={item.id} className="relative pl-3 pb-3 border-l border-white/[0.04] last:pb-0">
                                            ...
                                            <div className="flex justify-between items-start -mt-1">
                                                <div>
                                                    ...
                                                    <div className="text-xs text-white/60 mt-0.5">{item.time}</div>
                                                </div>
                                                {item.score && (
                            ...
                            <TabsContent value="vehicle" className="mt-0 p-1">
                                {assignment ? (
                                    <div className="space-y-2">
                                        <div className="bg-white/[0.04] p-2 rounded-md border border-white/[0.04] flex flex-col items-center">
                                            ...
                                            <div className="text-sm text-white/60">{assignment.number}</div>
                                            <Badge className="mt-2" variant={assignment.status === 'active' ? 'default' : 'secondary'}>
                                                {assignment.status}
                                            </Badge>
                                        </div>
                                        <div className="grid grid-cols-2 gap-3">
                                            <div className="p-3 bg-white/[0.04] rounded-lg border border-white/[0.04]">
                                                <div className="text-xs text-white/60 uppercase font-semibold">Fuel Level</div>
                                                <div className="text-sm font-bold text-white">{assignment.fuelLevel || '76'}%</div>
                                            </div>
                                            <div className="p-3 bg-white/[0.04] rounded-lg border border-white/[0.04]">
                                                <div className="text-xs text-white/60 uppercase font-semibold">Odometer</div>
