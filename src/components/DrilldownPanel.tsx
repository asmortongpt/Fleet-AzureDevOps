        ...
        <>
          ...
          <div
            className={cn(
              ...
              'bg-[#0a0a0a]/95 backdrop-blur-2xl border-l border-white/[0.15] shadow-sm z-50',
              'flex flex-col',
              className
            )}
            role="dialog"
          ...
          >
            {/* Header */}
            <div className="flex items-center justify-between p-2 border-b border-white/[0.15]/50 bg-[#111]/20 backdrop-filter backdrop-blur-sm">
