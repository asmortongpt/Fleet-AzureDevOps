                ...
                if (geofence.type === "circle" && geofence.center) {
                    ...
                    return (
                        ...
                        >
                            ...
                            {/* Tooltip */}
                            <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none bg-[var(--surface-2)] text-white text-xs py-1 px-2 rounded whitespace-nowrap z-30">
                                <div className="font-semibold">{geofence.name}</div>
                                <div className="text-[10px] text-[var(--text-secondary)]">{geofence.type} • {geofence.radius}m</div>
