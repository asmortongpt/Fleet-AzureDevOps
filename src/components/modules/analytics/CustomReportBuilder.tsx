  ...
  return (
    <div className="space-y-2">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-base font-bold text-[var(--text-primary)]">Custom Report Builder</h1>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
            ...
            <CardContent>
              {myReports.length === 0 ? (
                <div className="text-center py-3">
                  <p className="text-[var(--text-tertiary)]">You haven't created any custom reports yet.</p>
        ...
        <TabsContent value="history" className="space-y-2">
          <Card>
            ...
            <CardContent>
              <p className="text-center text-[var(--text-tertiary)] py-3">Execution history will be displayed here.</p>
            </CardContent>
          </Card>
        </TabsContent>
      </Tabs>
