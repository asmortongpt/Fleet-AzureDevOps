    ...
    return (
      <div className="flex items-center justify-center h-screen bg-white/[0.05]">
        <div className="text-center">
          ...
          <p className="mt-2 text-[var(--text-tertiary)]" style={{ color: brandColors.archon.mediumGray }}>Loading your dashboard...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="space-y-2">
      {dashboardData.assignments.length === 0 ? (
        <div className="bg-white rounded-lg p-3 text-center">
          <Car className="w-16 h-16 text-[var(--text-tertiary)] mx-auto mb-2" />
        ...
        dashboardData.assignments.map((assignment: Assignment) => (
          <div key={assignment.id} className="bg-white rounded-lg shadow p-2">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex items-center gap-2 text-[var(--text-tertiary)]" style={{ color: brandColors.archon.mediumGray }}>
                ...
                <div className="mt-3 pt-3 border-t border-[var(--border-default)]">
                  <div className="flex items-start gap-2 text-[var(--text-tertiary)]">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-[var(--text-tertiary)]">{assignment.secured_parking_address}</p>
                    </div>
                  </div>
  ...
  const renderTripsTab = () => (
    <div className="space-y-2">
      ...
      {dashboardData.recent_callback_trips.length === 0 ? (
        <div className="bg-white rounded-lg p-3 text-center">
          <Navigation className="w-16 h-16 text-[var(--text-tertiary)] mx-auto mb-2" />
          ...
          <div key={trip.id} className="bg-white rounded-lg shadow p-2">
            <div className="flex items-start justify-between mb-2">
              <div>
                ...
                <p className="text-sm text-[var(--text-tertiary)]" style={{ color: brandColors.archon.mediumGray }}>{trip.purpose}</p>
              </div>
          ...
          <div className="p-3 space-y-2">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2">
                ...
                />
                <label htmlFor="private-vehicle" className="text-sm text-[var(--text-tertiary)]">
