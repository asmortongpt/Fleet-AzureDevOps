    ...
    <div className="space-y-2">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-[var(--text-primary)] mt-1" style={{ color: brandColors.archon.mediumGray }}>Customize the appearance of exported policy and SOP documents</p>
        </div>
                ...
                {config.logo.base64 && (
                  <div className="mt-2">
                    <img
                      ...
                      alt="Logo preview"
                      className="max-w-xs border border-[var(--border-strong)] rounded p-2 bg-white"
                    />
                  </div>
                )}
              </div>
