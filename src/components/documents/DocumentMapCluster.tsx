...
export function DocumentMapCluster({
  ...
  return (
    <div className={`relative ${className}`}>
                ...
                <Popup maxWidth={400} minWidth={300}>
                  <div className="p-2">
                    ...
                    <div className="flex items-center justify-between mb-3 pb-3 border-b border-[var(--border-default)]">
                      ...
                      <div
                        className="w-12 h-9 rounded-full flex items-center justify-center text-white font-bold"
      ...
      {/* Legend */}
      <div className="absolute bottom-4 right-4 bg-white dark:bg-[var(--surface-3)] p-2 rounded-lg z-[1000]">
        <h4 className="font-semibold text-[var(--text-primary)] dark:text-[var(--text-primary)] text-sm mb-3">
          Document Density
        </h4>
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            <div className="w-4 h-4 rounded-full bg-[#DC2626]" />
            <span className="text-xs text-[var(--text-primary)] dark:text-[var(--text-tertiary)]">High (70%+)</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-4 h-4 rounded-full bg-[#F59E0B]" />
            <span className="text-xs text-[var(--text-primary)] dark:text-[var(--text-tertiary)]">Medium-High (40-70%)</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-4 h-4 rounded-full bg-[#10b981]" />
            <span className="text-xs text-[var(--text-primary)] dark:text-[var(--text-tertiary)]">Medium (20-40%)</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-4 h-4 rounded-full bg-[#10B981]" />
            <span className="text-xs text-[var(--text-primary)] dark:text-[var(--text-tertiary)]">Low (&lt;20%)</span>
          </div>
        </div>
      </div>

      {/* Total clusters badge */}
      <div className="absolute bottom-4 left-4 bg-white dark:bg-[var(--surface-3)] px-3 py-2 rounded-lg text-sm z-[1000]">
        <div className="flex items-center gap-2">
          <svg
          ...
          <span className="font-medium text-[var(--text-tertiary)] dark:text-[var(--text-secondary)]">
