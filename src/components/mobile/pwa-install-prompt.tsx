...
export function PWAInstallPrompt() {
  ...
  return (
    <div
      className="fixed bottom-0 left-0 right-0 z-[9998] bg-gradient-to-r from-emerald-600 to-emerald-700 text-white shadow-sm"
      role="dialog"
            ...
            <div className="flex items-center gap-3 mt-2">
              {!isIOS && deferredPrompt && (
                <button
                  ...
                  className="flex items-center gap-2 px-2 py-2 bg-white text-emerald-700 rounded-lg font-medium hover:bg-emerald-500/5 transition-colors text-sm md:text-base"
                >
