...
export const AssetTypeFilter: React.FC<AssetTypeFilterProps> = ({
  ...
  return (
    <div className="bg-white rounded-lg border border-[var(--border-default)]">
      {/* Filter Header */}
      <div className="flex items-center justify-between p-2 border-b border-[var(--border-default)]">
        <div className="flex items-center gap-2">
          <Filter className="w-3 h-3 text-[var(--text-primary)]" />
          <h3 className="font-semibold text-[var(--text-primary)]">Asset Filters</h3>
          {activeFilterCount > 0 && (
      ...
      {activeFilterCount > 0 && (
        <div className="flex flex-wrap gap-2 p-2 border-b border-[var(--border-default)] bg-white/[0.03]">
        ...
        <div className="p-2 space-y-2">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2 border border-[var(--border-default)] rounded-md focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
            >
