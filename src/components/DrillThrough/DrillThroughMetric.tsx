  ...
  return (
    <>
      <button
        ...
        className={`inline-flex items-center gap-1 text-emerald-800 dark:text-emerald-700 hover:text-emerald-800 dark:hover:text-emerald-300 underline decoration-dashed underline-offset-2 hover:decoration-solid transition-all cursor-pointer ${className}`}
