  ...
  return (
    <>
      <button
        ...
        className={`inline-flex items-center gap-1 text-blue-800 dark:text-blue-700 hover:text-blue-800 dark:hover:text-blue-300 underline decoration-dashed underline-offset-2 hover:decoration-solid transition-all cursor-pointer ${className}`}
