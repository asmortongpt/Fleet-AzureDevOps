  ...
  return (
    ...
    >
      <div className="text-center max-w-md px-3">
        ...
        <p className="text-sm text-[var(--text-secondary)] mb-2">{stages[loadingStage]}</p>
...
function AnimatedLoadingSkeleton({ minHeight }: { minHeight: number }) {
  return (
    <div
      ...
      aria-label="Loading map"
    >
      <div className="absolute inset-0 bg-[var(--surface-1)] animate-pulse" />
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="text-center bg-[var(--surface-2)] p-3 rounded-lg border border-[var(--border-subtle)]">
          ...
          <p className="text-sm text-[var(--text-secondary)]">Preparing geographic interface...</p>
  ...
  return (
    ...
    >
      <div className="text-center p-3 max-w-md">
        ...
        <p className="text-sm text-[var(--text-secondary)] mb-1">{error instanceof Error ? error.message : String(error)}</p>
        ...
        {import.meta.env.MODE === 'development' && (
          <details className="mt-3 text-left">
            <summary className="text-xs text-[var(--text-tertiary)] cursor-pointer hover:text-white">
