  ...
  return (
    <div className="max-w-6xl mx-auto p-3 space-y-2">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-base font-bold text-white/80">Vehicle Management</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-2">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
              ...
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-emerald-500 ${
                    touched.vin && errors.vin ? 'border-red-500' : 'border-white/[0.08]'
                  }`}
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-emerald-500 ${
                    touched.make && errors.make ? 'border-red-500' : 'border-white/[0.08]'
                  }`}
                  placeholder="Honda"
                />
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-emerald-500 ${
                    touched.model && errors.model ? 'border-red-500' : 'border-white/[0.08]'
                  }`}
                  placeholder="Accord"
                />
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-emerald-500 ${
                    touched.year && errors.year ? 'border-red-500' : 'border-white/[0.08]'
                  }`}
                  placeholder="2023"
                />
              ...
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-white/[0.08] rounded-md focus:ring-2 focus:ring-emerald-500"
                  placeholder="Black"
                />
              </div>
            </div>
            ...
            <div className="flex justify-end space-x-3 pt-2 border-t">
              <button
                ...
                className="px-3 py-2 border border-white/[0.08] rounded-md text-white/40 hover:bg-white/[0.03] disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Cancel
              </button>
              <button
        ...
        <div className="p-3">
          ...
          {!isLoadingVehicles && !loadError && vehicles.length === 0 && (
            <div className="text-center py-12 text-white/40">
              <svg
                className="mx-auto h-9 w-12 text-white/40"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-white/[0.03]">
                  <tr>
                    <th className="px-3 py-3 text-left text-xs font-medium text-white/40 uppercase tracking-wider">
                      VIN
                    </th>
                    <th className="px-3 py-3 text-left text-xs font-medium text-white/40 uppercase tracking-wider">
                      Make
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {vehicles.map((vehicle) => (
                    <tr key={vehicle.id} className="hover:bg-white/[0.03]">
                      <td className="px-3 py-2 whitespace-nowrap text-sm font-medium text-white/80">
                        {vehicle.vin}
                      </td>
                      <td className="px-3 py-2 whitespace-nowrap text-sm text-white/40">
                        {vehicle.make}
                      </td>
                      <td className="px-3 py-2 whitespace-nowrap text-sm text-white/40">
                        {vehicle.model}
