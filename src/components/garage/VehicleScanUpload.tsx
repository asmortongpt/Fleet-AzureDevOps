...
export function VehicleScanUpload({
  ...
  return (
    <div className="absolute inset-0 z-30 flex items-center justify-center bg-black/60 backdrop-blur-sm">
      <div className="w-full max-w-2xl max-h-[90vh] bg-[#0e0e0e] rounded-2xl border border-white/[0.04] overflow-hidden flex flex-col">
        {/* Header */}
              ...
              {scanMode === 'guided' ? (
                ...
                <>
                  ...
                  <div
                    ...
                    className={cn(
                      ...
                      isDragging
                        ...
                        : 'border-white/[0.04] hover:border-white/[0.20] bg-white/[0.02]'
                    )}
                  >
                  ...
                  <button
                    ...
                    className="w-full py-2.5 rounded-lg bg-white/[0.05] border border-white/[0.04] text-sm text-white/60 hover:text-white/80 hover:bg-white/[0.08] transition-colors flex items-center justify-center gap-2"
                  >
          ...
          {stage === 'complete' && results && (
            <div className="space-y-4">
              ...
              {results.damage_report && (
                <div className="rounded-xl bg-white/[0.04] border border-white/[0.04] p-4">
              ...
              {scanId && (
                <div className="space-y-2">
                  ...
                  {aiAssessment && (
                    <div className="rounded-xl bg-white/[0.04] border border-white/[0.04] p-4 space-y-3">
                      <div className="flex items-center gap-2">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {results.showroom_images.map((url, i) => (
                      <div
                        key={i}
                        className="rounded-lg overflow-hidden border border-white/[0.04] bg-[#0a0a0a]"
                      >
                        <img
