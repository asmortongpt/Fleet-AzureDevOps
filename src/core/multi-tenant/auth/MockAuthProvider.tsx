...
export const MockAuthLoading: React.FC = () => (
  <div style={{
    ...
    <div style={{
      ...
      <p style={{color: '#374151'}}>Initializing authentication...</p>
    </div>
  </div>
)
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{textAlign: 'center', marginBottom: '24px'}}>
          ...
          <p style={{color: '#374151'}}>Mock Authentication System</p>
        </div>
...
export const MockRoleSwitcher: React.FC = () => {
  ...
  return (
    <div style={{
      ...
      <div style={{marginBottom: '8px', fontSize: '12px', color: '#374151'}}>
