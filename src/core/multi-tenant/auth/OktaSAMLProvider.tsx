  ...
  transformAuthState: async (oktaAuth: OktaAuth, authState: AuthState): Promise<AuthState> => {
    ...
    if (authState.isAuthenticated && authState.idToken?.claims) {
      ...
      const dcfUser: DCFUser = {
        ...
        accountStatus: (claims['dcf:account_status'] as DCFUser['accountStatus']) || 'active',
        ...
        securityClearance: (claims['dcf:clearance'] as DCFUser['securityClearance']) || 'basic',
      ...
      // logger.debug('✅ DCF User authenticated:', {
...
const handleSecurityEvent = (event: string, data: any) => {
  ...
  // logger.debug('🔒 Security Event:', securityLog);
