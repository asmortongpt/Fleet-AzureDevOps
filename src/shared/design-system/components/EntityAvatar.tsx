 ...
 *
 * Professional entity representation with status-indicating ring.
 * Used for vehicles, drivers, parts, and records.
 *
 * Features:
 * - Conic gradient status ring (good/warn/bad/info)
