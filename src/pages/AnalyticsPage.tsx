...
function KPICard({ title, value, change, changeLabel, icon, trend = 'neutral', variant = 'default' }: KPICardProps) {
  ...
  return (
    <Card className={`${variantStyles[variant]} backdrop-blur-xl border transition-all duration-300 hover:scale-105 hover:shadow-sm`}>
...
export function AnalyticsPage() {
      ...
      <div className="flex items-center justify-center h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
        <div className="text-center space-y-2">
          <div className="relative">
            ...
            <Activity className="w-4 h-4 text-blue-800 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2" />
          </div>
          <div>
            <p className="text-sm font-medium text-white">Loading Analytics Dashboard</p>
      ...
      <div className="flex items-center justify-center h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
        <Card className="max-w-md border-red-700/50 bg-red-900/20 backdrop-blur-xl">
          <CardContent className="p-3 text-center space-y-2">
            <AlertTriangle className="w-12 h-9 text-red-500 mx-auto" />
            <div>
              <h2 className="text-base font-bold text-white">Failed to Load Analytics</h2>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-3" data-testid="analytics-page">
      {/* Header */}
      <div className="mb-3">
        <div className="flex items-center justify-between">
          <div>
            ...
            >
              <div className="space-y-3 mt-2">
                ...
                <div className="border-t border-slate-700/50 pt-2 flex items-center justify-between">
                  ...
                  <span className="text-sm font-bold text-blue-300">${analytics.costs.costPerMile}</span>
                </div>
              </div>
            </ChartCard>
