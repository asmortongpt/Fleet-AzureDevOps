    ...
    return (
        <div className="p-3 space-y-2 bg-gradient-to-b from-slate-900/50 to-transparent">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-2">
                <StatCard title="Users" value="156" variant="primary" icon={<Users className="w-4 h-4" />} onClick={() => push({ id: 'system-health', type: 'system-health', label: 'Users', data: { title: 'Users' } })} />
                ...
                <StatCard title="API Calls Today" value="12.4K" variant="default" icon={<CloudArrowUp className="w-4 h-4" />} onClick={() => push({ id: 'system-health', type: 'system-health', label: 'API Calls', data: { title: 'API Calls' } })} />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-2">
                <div className="bg-gradient-to-br from-slate-800/60 to-slate-900/60 backdrop-blur-xl rounded-md border border-slate-700/50 p-3 cursor-pointer hover:border-slate-600/50 transition-colors" onClick={() => push({ id: 'system-health', type: 'system-health', label: 'System Health', data: { title: 'System Health' } })}>
                    <h3 className="text-sm font-medium text-slate-400 uppercase tracking-wide mb-2">System Health</h3>
                    <ProgressRing progress={98} color="green" label="Healthy" />
                </div>
                <div className="bg-gradient-to-br from-slate-800/60 to-slate-900/60 backdrop-blur-xl rounded-md border border-slate-700/50 p-3 cursor-pointer hover:border-slate-600/50 transition-colors" onClick={() => push({ id: 'system-health', type: 'system-health', label: 'Resources', data: { title: 'Resources' } })}>
                    <h3 className="text-sm font-medium text-slate-400 uppercase tracking-wide mb-2">Resources</h3>
                    <QuickStat label="CPU Usage" value="24%" />
                    <QuickStat label="Memory" value="4.2 GB" />
                    <QuickStat label="Storage" value="67%" />
                </div>
                <div className="bg-gradient-to-br from-slate-800/60 to-slate-900/60 backdrop-blur-xl rounded-md border border-slate-700/50 p-3 cursor-pointer hover:border-slate-600/50 transition-colors" onClick={() => push({ id: 'system-health', type: 'system-health', label: 'API Health', data: { title: 'API Health' } })}>
                    <h3 className="text-sm font-medium text-slate-400 uppercase tracking-wide mb-2">API Health</h3>
...
function AlertsContent() {
    ...
    return (
        <div className="p-3 space-y-2 bg-gradient-to-b from-slate-900/50 to-transparent">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-2">
                <StatCard title="Active Alerts" value="3" variant="warning" icon={<Bell className="w-4 h-4" />} onClick={() => push({ id: 'system-alerts', type: 'system-alerts', label: 'Active Alerts', data: { title: 'Active Alerts' } })} />
...
function DocumentsContent() {
    ...
    return (
        <div className="p-3 space-y-2 bg-gradient-to-b from-slate-900/50 to-transparent">
            <h2 className="text-sm font-bold text-white">Document Management</h2>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-2">
                <StatCard title="Total Documents" value="1,245" variant="primary" icon={<FolderOpen className="w-4 h-4" />} onClick={() => push({ id: 'files', type: 'files', label: 'Total Documents', data: { title: 'Total Documents' } })} />
...
function PolicyContent() {
    ...
    return (
        <div className="p-3 space-y-2 bg-gradient-to-b from-slate-900/50 to-transparent">
            <h2 className="text-sm font-bold text-white">Policy Engine</h2>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-2">
                <StatCard title="Active Policies" value="24" variant="primary" icon={<Brain className="w-4 h-4" />} onClick={() => push({ id: 'system-health', type: 'system-health', label: 'Active Policies', data: { title: 'Active Policies' } })} />
...
function FormsContent() {
    ...
    return (
        <div className="p-3 space-y-2 bg-gradient-to-b from-slate-900/50 to-transparent">
            <h2 className="text-sm font-bold text-white">Form Builder</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
                <StatCard title="Templates" value="18" variant="primary" icon={<FileText className="w-4 h-4" />} onClick={() => push({ id: 'files', type: 'files', label: 'Form Templates', data: { title: 'Form Templates' } })} />
...
function SettingsContent() {
    ...
    return (
        <div className="p-3 space-y-2 bg-gradient-to-b from-slate-900/50 to-transparent">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
                <StatCard title="Configurations" value="45" variant="primary" icon={<GearSix className="w-4 h-4" />} onClick={() => push({ id: 'system-health', type: 'system-health', label: 'Configurations', data: { title: 'Configurations' } })} />
                ...
                <StatCard title="API Keys" value="8" variant="default" icon={<Key className="w-4 h-4" />} onClick={() => push({ id: 'system-health', type: 'system-health', label: 'API Keys', data: { title: 'API Keys' } })} />
            </div>
        </div>
    )
}
