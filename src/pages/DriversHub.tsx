...
function ScorecardContent() {
    return (
        <div className="p-4 sm:p-6 space-y-4 sm:space-y-6 bg-gradient-to-b from-background to-background/95 overflow-auto">
            <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-foreground">Driver Scorecard</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                <StatCard
...
function PersonalUseContent() {
    return (
        <div className="p-4 sm:p-6 space-y-4 sm:space-y-6 bg-gradient-to-b from-background to-background/95 overflow-auto">
            <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-foreground">Personal Use Tracking</h2>
...
function PolicyContent() {
    return (
        <div className="p-4 sm:p-6 space-y-4 sm:space-y-6 bg-gradient-to-b from-background to-background/95 overflow-auto">
            <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-foreground">Personal Use Policy</h2>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
                <StatCard
