    ...
    return (
        <div className="p-8 space-y-8 bg-gradient-to-b from-slate-900/50 via-transparent to-transparent">
            ...
            <div className="flex items-center justify-between">
                <div>
                    <h2 className="text-3xl font-bold text-white mb-2">Parts Inventory Management</h2>
                    <p className="text-slate-400">Real-time inventory tracking, stock analytics, and automated reordering</p>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div className="bg-gradient-to-br from-slate-800/70 to-slate-900/70 backdrop-blur-xl rounded-2xl border border-slate-700/50 p-8 cursor-pointer hover:border-blue-500/50 hover:shadow-xl hover:shadow-blue-500/10 transition-all duration-300"
                    ...
                    <div className="flex items-start justify-between mb-6">
                        <h3 className="text-lg font-semibold text-white">Stock Health Overview</h3>
                    ...
                    <div className="space-y-5">
                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between items-center">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-sm font-medium text-white">Healthy Stock</span>
                                </div>
                                <span className="text-sm font-bold text-emerald-400">1,065 SKUs</span>
                            </div>
                            <div className="w-full bg-slate-900/50 rounded-full h-2.5">
                                <div className="bg-gradient-to-r from-emerald-500 to-emerald-400 h-2.5 rounded-full" style={{ width: '85.5%' }}></div>
                            </div>
                            <div className="text-xs text-slate-500">Above reorder point • 85.5% of inventory</div>
                        </div>
                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between items-center">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-sm font-medium text-white">Adequate Stock</span>
                                </div>
                                <span className="text-sm font-bold text-blue-400">115 SKUs</span>
                            </div>
                            <div className="w-full bg-slate-900/50 rounded-full h-2.5">
                                <div className="bg-gradient-to-r from-blue-500 to-blue-400 h-2.5 rounded-full" style={{ width: '9.2%' }}></div>
                            </div>
                            <div className="text-xs text-slate-500">Near reorder point • 9.2% of inventory</div>
                        </div>
                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between items-center">
                                ...
                                <span className="text-sm font-bold text-amber-400">42 SKUs</span>
                            </div>
                            <div className="w-full bg-slate-900/50 rounded-full h-2.5">
                                <div className="bg-gradient-to-r from-amber-500 to-amber-400 h-2.5 rounded-full" style={{ width: '3.4%' }}></div>
                            </div>
                            <div className="text-xs text-slate-500">Below reorder point • 3.4% of inventory</div>
                        </div>
                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between items-center">
                                ...
                                <span className="text-sm font-bold text-red-400">23 SKUs</span>
                            </div>
                            <div className="w-full bg-slate-900/50 rounded-full h-2.5">
                                <div className="bg-gradient-to-r from-red-500 to-red-400 h-2.5 rounded-full" style={{ width: '1.9%' }}></div>
                            </div>
                            <div className="text-xs text-slate-500">Zero quantity • 1.9% of inventory</div>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-gradient-to-br from-slate-800/70 to-slate-900/70 backdrop-blur-xl rounded-2xl border border-slate-700/50 p-8 cursor-pointer hover:border-blue-500/50 hover:shadow-xl hover:shadow-blue-500/10 transition-all duration-300"
                    ...
                    <div className="flex items-start justify-between mb-6">
                        <h3 className="text-lg font-semibold text-white">Inventory Turnover Analysis</h3>
                    ...
                    <div className="space-y-4">
                        <div className="p-4 bg-slate-900/50 rounded-lg">
                            <div className="flex justify-between items-center mb-2">
                                <span className="text-sm text-slate-400">Fast-Moving Parts</span>
                                <span className="text-xs px-2 py-1 bg-emerald-500/20 text-emerald-400 rounded-full">Optimal</span>
                            </div>
                            <div className="text-2xl font-bold text-emerald-400 mb-1">342 SKUs</div>
                            <div className="text-xs text-slate-500">Turnover > 12x/year • 27.5% of catalog</div>
                        </div>

                        <div className="p-4 bg-slate-900/50 rounded-lg">
                            <div className="flex justify-between items-center mb-2">
                                <span className="text-sm text-slate-400">Slow-Moving Parts</span>
                                <span className="text-xs px-2 py-1 bg-amber-500/20 text-amber-400 rounded-full">Monitor</span>
                            </div>
                            <div className="text-2xl font-bold text-amber-400 mb-1">156 SKUs</div>
                            <div className="text-xs text-slate-500">Turnover < 2x/year • 12.5% of catalog</div>
                        </div>

                        <div className="p-4 bg-blue-500/10 rounded-lg border border-blue-500/20">
                            <div className="flex justify-between items-center">
                                <span className="text-sm text-blue-400">Avg Days to Turnover</span>
                                <span className="text-lg font-bold text-blue-400">43 days</span>
                            </div>
                            <div className="text-xs text-blue-400/70 mt-1">Industry avg: 52 days • 17% better</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-slate-800/70 to-slate-900/70 backdrop-blur-xl rounded-2xl border border-slate-700/50 p-8">
                <div className="flex items-start justify-between mb-6">
                    <div>
                        <h3 className="text-lg font-semibold text-white mb-2">Parts by Category</h3>
                        <p className="text-sm text-slate-400">Inventory distribution across major part categories</p>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {/* Engine Parts */}
                    <div className="bg-slate-900/30 hover:bg-slate-900/50 rounded-xl border border-slate-700/30 p-6 cursor-pointer transition-all">
                        <div className="flex items-start justify-between mb-4">
                            <div className="p-3 bg-blue-500/10 rounded-lg">
                                <Engine className="w-6 h-6 text-blue-400" />
                            </div>
                            <span className="text-xs px-2 py-1 bg-emerald-500/20 text-emerald-400 rounded-full">98% in stock</span>
                        </div>
                        <h4 className="text-sm font-medium text-white mb-1">Engine Parts</h4>
                        <div className="text-2xl font-bold text-white mb-2">324</div>
                        <div className="text-xs text-slate-400 mb-4">SKUs • $89.4K value</div>
                        <div className="w-full bg-slate-900/50 rounded-full h-1.5">
                            <div className="bg-gradient-to-r from-blue-500 to-blue-400 h-1.5 rounded-full" style={{ width: '26%' }}></div>
                        </div>
                        <div className="text-xs text-slate-500 mt-2">26% of total inventory</div>
                    </div>
                    ...
                    <div className="bg-slate-900/30 hover:bg-slate-900/50 rounded-xl border border-slate-700/30 p-6 cursor-pointer transition-all">
                        <div className="flex items-start justify-between mb-4">
                            ...
                            <span className="text-xs px-2 py-1 bg-emerald-500/20 text-emerald-400 rounded-full">96% in stock</span>
                        </div>
                        <h4 className="text-sm font-medium text-white mb-1">Electrical</h4>
                        <div className="text-2xl font-bold text-white mb-2">268</div>
                        <div className="text-xs text-slate-400 mb-4">SKUs • $72.1K value</div>
                        <div className="w-full bg-slate-900/50 rounded-full h-1.5">
                            <div className="bg-gradient-to-r from-amber-500 to-amber-400 h-1.5 rounded-full" style={{ width: '21.5%' }}></div>
                        </div>
                        <div className="text-xs text-slate-500 mt-2">21.5% of total inventory</div>
                    </div>
                    ...
                    <div className="bg-slate-900/30 hover:bg-slate-900/50 rounded-xl border border-slate-700/30 p-6 cursor-pointer transition-all">
                        <div className="flex items-start justify-between mb-4">
                            ...
                            <span className="text-xs px-2 py-1 bg-amber-500/20 text-amber-400 rounded-full">92% in stock</span>
                        </div>
                        <h4 className="text-sm font-medium text-white mb-1">Brakes & Suspension</h4>
                        <div className="text-2xl font-bold text-white mb-2">412</div>
                        <div className="text-xs text-slate-400 mb-4">SKUs • $124.6K value</div>
                        <div className="w-full bg-slate-900/50 rounded-full h-1.5">
                            <div className="bg-gradient-to-r from-purple-500 to-purple-400 h-1.5 rounded-full" style={{ width: '33.1%' }}></div>
                        </div>
                        <div className="text-xs text-slate-500 mt-2">33.1% of total inventory</div>
                    </div>
                    ...
                    <div className="bg-slate-900/30 hover:bg-slate-900/50 rounded-xl border border-slate-700/30 p-6 cursor-pointer transition-all">
                        <div className="flex items-start justify-between mb-4">
                            ...
                            <span className="text-xs px-2 py-1 bg-emerald-500/20 text-emerald-400 rounded-full">94% in stock</span>
                        </div>
                        <h4 className="text-sm font-medium text-white mb-1">Fluids & Filters</h4>
                        <div className="text-2xl font-bold text-white mb-2">241</div>
                        <div className="text-xs text-slate-400 mb-4">SKUs • $56.7K value</div>
                        <div className="w-full bg-slate-900/50 rounded-full h-1.5">
                            <div className="bg-gradient-to-r from-emerald-500 to-emerald-400 h-1.5 rounded-full" style={{ width: '19.4%' }}></div>
                        </div>
                        <div className="text-xs text-slate-500 mt-2">19.4% of total inventory</div>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-slate-800/70 to-slate-900/70 backdrop-blur-xl rounded-2xl border border-slate-700/50 p-8">
                <div className="flex items-start justify-between mb-6">
                    <div>
                        <h3 className="text-lg font-semibold text-white mb-2">Critical Stock Alerts</h3>
                        <p className="text-sm text-slate-400">Immediate attention required • Auto-reorder enabled</p>
                    </div>
                    <span className="text-xs px-2 py-1 bg-red-500/20 text-red-400 rounded-full">23 urgent alerts</span>
                </div>
                ...
                <div className="space-y-3">
                    <div className="flex items-center justify-between p-4 bg-gradient-to-r from-red-500/10 to-transparent rounded-lg border-l-2 border-red-500">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <div className="text-sm font-medium text-white">Oil Filter - 10W-30</div>
                                <div className="text-xs text-slate-400">SKU: FLT-10W30-001 • High demand part</div>
                            </div>
                        </div>
                        <div className="flex items-center gap-6">
                            <div className="text-right">
                                <div className="text-sm font-bold text-red-400">0 units</div>
                                <div className="text-xs text-red-400">Out of stock</div>
                            </div>
                            <button className="px-3 py-1.5 bg-blue-600/90 hover:bg-blue-500 text-white rounded-lg text-xs font-medium">
                                Order Now
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between p-4 bg-gradient-to-r from-amber-500/10 to-transparent rounded-lg border-l-2 border-amber-500">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <div className="text-sm font-medium text-white">Brake Pads - Heavy Duty</div>
                                <div className="text-xs text-slate-400">SKU: BRK-HD-7890 • Critical safety part</div>
                            </div>
                        </div>
                        <div className="flex items-center gap-6">
                            <div className="text-right">
                                <div className="text-sm font-bold text-amber-400">3 units</div>
                                <div className="text-xs text-amber-400">Below min: 12</div>
                            </div>
                            <button className="px-3 py-1.5 bg-blue-600/90 hover:bg-blue-500 text-white rounded-lg text-xs font-medium">
                                Reorder
                            </button>
                    ...
                    <div className="flex items-center justify-between p-4 bg-gradient-to-r from-red-500/10 to-transparent rounded-lg border-l-2 border-red-500">
                        <div className="flex items-center gap-4">
                            <XCircle className="w-5 h-5 text-red-400" weight="fill" />
                            <div>
                                <div className="text-sm font-medium text-white">Spark Plugs - NGK Premium</div>
                                <div className="text-xs text-slate-400">SKU: SPK-NGK-4421 • Fast-moving item</div>
                            </div>
                        </div>
                        <div className="flex items-center gap-6">
                            <div className="text-right">
                    ...
                    <div className="flex items-center justify-between p-4 bg-gradient-to-r from-amber-500/10 to-transparent rounded-lg border-l-2 border-amber-500">
                        <div className="flex items-center gap-4">
                            <Warning className="w-5 h-5 text-amber-400" weight="fill" />
                            <div>
                                <div className="text-sm font-medium text-white">Alternator Belt - Serpentine</div>
                                <div className="text-xs text-slate-400">SKU: BLT-SERP-9012 • Common replacement</div>
                            </div>
                        </div>
                        <div className="flex items-center gap-6">
                            <div className="text-right">
                                <div className="text-sm font-bold text-amber-400">5 units</div>
                                <div className="text-xs text-amber-400">Below min: 15</div>
                            </div>
                            <button className="px-3 py-1.5 bg-blue-600/90 hover:bg-blue-500 text-white rounded-lg text-xs font-medium">
                                Reorder
                            </button>
                    ...
                    <div className="flex items-center justify-between p-4 bg-gradient-to-r from-red-500/10 to-transparent rounded-lg border-l-2 border-red-500">
                        <div className="flex items-center gap-4">
                            <XCircle className="w-5 h-5 text-red-400" weight="fill" />
                            <div>
                                <div className="text-sm font-medium text-white">Transmission Fluid - Dexron VI</div>
                                <div className="text-xs text-slate-400">SKU: FLD-DEX6-3344 • High usage</div>
                            </div>
                        </div>
                        <div className="flex items-center gap-6">
                            <div className="text-right">
