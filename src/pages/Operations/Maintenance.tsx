...
, SplitView } from "@/components/operations";
  ...
  const renderTaskItem = (task: MaintenanceRecord) => {
    ...
    return (
      <div
        ...
        className={cn(
          'p-4 border-b border-[var(--border-subtle)] cursor-pointer transition-all duration-200',
          'hover:bg-muted',
      ...
      <div className="p-4 space-y-3 border-b border-[var(--border-subtle)]">
        <div className="relative">
          ...
          <Input
            ...
            className="pl-10 bg-muted border-[var(--border-subtle)] text-foreground"
            disabled={loading}
          />
        </div>
        ...
        <select
          ...
          className="w-full px-3 py-2 bg-muted border border-[var(--border-subtle)] rounded-md text-foreground text-sm disabled:opacity-50"
          disabled={loading}
        >
        ...
        {/* Statistics Summary */}
        {stats && (
          <div className="grid grid-cols-2 gap-2 text-xs bg-[var(--surface-2)] rounded-lg p-3 border border-[var(--border-subtle)]">
            <div>
