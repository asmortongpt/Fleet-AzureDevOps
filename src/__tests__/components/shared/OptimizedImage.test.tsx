...
describe('OptimizedImage', () => {
  ...
  describe('Props', () => {
    ...
    it('should handle data attributes', () => {
      const { container } = render(<OptimizedImage data-testid="test-component" />);
  ...
  describe('User Interactions', () => {
    it('should handle click events', async () => {
      ...
      render(<OptimizedImage onClick={handleClick} />);
    ...
    it('should handle keyboard events', async () => {
      ...
      render(<OptimizedImage onKeyDown={handleKeyDown} />);
    ...
    it('should handle form submission', async () => {
      ...
      render(<OptimizedImage onSubmit={handleSubmit} />);
  ...
  describe('State Management', () => {
    ...
    it('should maintain internal state', () => {
      const { rerender } = render(<OptimizedImage />);
      rerender(<OptimizedImage />);
  ...
  describe('Error Handling', () => {
    it('should handle errors gracefully', () => {
      ...
      render(<OptimizedImage invalidProp={undefined} />);
    ...
    it('should display error messages', () => {
      render(<OptimizedImage error="Test error" />);
  ...
  describe('Conditional Rendering', () => {
    it('should render when condition is met', () => {
      render(<OptimizedImage show={true} />);
      expect(screen.getByRole('main', { hidden: true })).toBeInTheDocument();
    });

    it('should not render when condition is not met', () => {
      const { container } = render(<OptimizedImage show={false} />);
      expect(container.firstChild).toBeNull();
    });

    it('should toggle visibility', async () => {
      const { rerender } = render(<OptimizedImage show={false} />);
      expect(screen.queryByRole('main')).not.toBeInTheDocument();

      rerender(<OptimizedImage show={true} />);
      expect(screen.getByRole('main', { hidden: true })).toBeInTheDocument();
    });
  });
  ...
  describe('Performance', () => {
    it('should memoize expensive computations', () => {
      ...
      render(<OptimizedImage compute={expensiveFunction} />);

      expect(expensiveFunction).toHaveBeenCalledTimes(1);
    });

    it('should not re-render unnecessarily', () => {
      const { rerender } = render(<OptimizedImage value="test" />);
      const renderCount = vi.fn();

      rerender(<OptimizedImage value="test" />);
  ...
  describe('Security', () => {
    it('should sanitize user input', () => {
      ...
      render(<OptimizedImage value={maliciousInput} />);
    ...
    it('should escape HTML entities', () => {
      ...
      render(<OptimizedImage value={htmlInput} />);
