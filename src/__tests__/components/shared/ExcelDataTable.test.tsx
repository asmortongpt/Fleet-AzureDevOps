...
import { ExcelDataTable } from '../../components/shared/ExcelDataTable';

describe('ExcelDataTable', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  describe('Rendering', () => {
    it('should render without crashing', () => {
      const { container } = render(<ExcelDataTable />);
      expect(container).toBeTruthy();
    });

    it('should render with default props', () => {
      render(<ExcelDataTable />);
  ...
  describe('Props', () => {
    it('should accept and apply className prop', () => {
      const { container } = render(<ExcelDataTable className="test-class" />);
      expect(container.firstChild).toHaveClass('test-class');
    });

    it('should handle data attributes', () => {
      const { container } = render(<ExcelDataTable data-testid="test-component" />);
      expect(container.firstChild).toHaveAttribute('data-testid', 'test-component');
    });

    it('should render with custom props', () => {
      const customProps = { title: 'Test Title' };
      render(<ExcelDataTable {...customProps} />);
  ...
  describe('User Interactions', () => {
    it('should handle click events', async () => {
      ...
      render(<ExcelDataTable onClick={handleClick} />);
    ...
    it('should handle keyboard events', async () => {
      ...
      render(<ExcelDataTable onKeyDown={handleKeyDown} />);
    ...
    it('should handle form submission', async () => {
      ...
      render(<ExcelDataTable onSubmit={handleSubmit} />);
  ...
  describe('State Management', () => {
    ...
    it('should maintain internal state', () => {
      const { rerender } = render(<ExcelDataTable />);
      rerender(<ExcelDataTable />);
  ...
  describe('Error Handling', () => {
    it('should handle errors gracefully', () => {
      ...
      render(<ExcelDataTable invalidProp={undefined} />);
    ...
    it('should display error messages', () => {
      render(<ExcelDataTable error="Test error" />);
  ...
  describe('Conditional Rendering', () => {
    it('should render when condition is met', () => {
      render(<ExcelDataTable show={true} />);
      expect(screen.getByRole('main', { hidden: true })).toBeInTheDocument();
    });

    it('should not render when condition is not met', () => {
      const { container } = render(<ExcelDataTable show={false} />);
      expect(container.firstChild).toBeNull();
    });

    it('should toggle visibility', async () => {
      const { rerender } = render(<ExcelDataTable show={false} />);
      expect(screen.queryByRole('main')).not.toBeInTheDocument();

      rerender(<ExcelDataTable show={true} />);
      expect(screen.getByRole('main', { hidden: true })).toBeInTheDocument();
    });
  });
  ...
  describe('Performance', () => {
    it('should memoize expensive computations', () => {
      ...
      render(<ExcelDataTable compute={expensiveFunction} />);

      expect(expensiveFunction).toHaveBeenCalledTimes(1);
    });

    it('should not re-render unnecessarily', () => {
      const { rerender } = render(<ExcelDataTable value="test" />);
      const renderCount = vi.fn();

      rerender(<ExcelDataTable value="test" />);
  ...
  describe('Security', () => {
    it('should sanitize user input', () => {
      ...
      render(<ExcelDataTable value={maliciousInput} />);
    ...
    it('should escape HTML entities', () => {
      ...
      render(<ExcelDataTable value={htmlInput} />);
