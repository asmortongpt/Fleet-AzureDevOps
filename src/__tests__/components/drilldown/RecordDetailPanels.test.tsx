...
import { AssetDetailPanel } from '../../components/drilldown/RecordDetailPanels';
...
describe('AssetDetailPanel', () => {
  ...
  describe('Rendering', () => {
    it('should render without crashing', () => {
      const { container } = render(<AssetDetailPanel />);
      expect(container).toBeTruthy();
    });

    it('should render with default props', () => {
      render(<AssetDetailPanel />);
  ...
  describe('Props', () => {
    it('should accept and apply className prop', () => {
      const { container } = render(<AssetDetailPanel className="test-class" />);
      expect(container.firstChild).toHaveClass('test-class');
    });

    it('should handle data attributes', () => {
      const { container } = render(<AssetDetailPanel data-testid="test-component" />);
      expect(container.firstChild).toHaveAttribute('data-testid', 'test-component');
    });

    it('should render with custom props', () => {
      const customProps = { title: 'Test Title' };
      render(<AssetDetailPanel {...customProps} />);
  ...
  describe('User Interactions', () => {
    it('should handle click events', async () => {
      ...
      render(<AssetDetailPanel onClick={handleClick} />);
    ...
    it('should handle keyboard events', async () => {
      ...
      render(<AssetDetailPanel onKeyDown={handleKeyDown} />);
    ...
    it('should handle form submission', async () => {
      ...
      render(<AssetDetailPanel onSubmit={handleSubmit} />);
  ...
  describe('State Management', () => {
    ...
    it('should maintain internal state', () => {
      const { rerender } = render(<AssetDetailPanel />);
      rerender(<AssetDetailPanel />);
  ...
  describe('Error Handling', () => {
    it('should handle errors gracefully', () => {
      ...
      render(<AssetDetailPanel invalidProp={undefined} />);
    ...
    it('should display error messages', () => {
      render(<AssetDetailPanel error="Test error" />);
  ...
  describe('Conditional Rendering', () => {
    it('should render when condition is met', () => {
      render(<AssetDetailPanel show={true} />);
      expect(screen.getByRole('main', { hidden: true })).toBeInTheDocument();
    });

    it('should not render when condition is not met', () => {
      const { container } = render(<AssetDetailPanel show={false} />);
      expect(container.firstChild).toBeNull();
    });

    it('should toggle visibility', async () => {
      const { rerender } = render(<AssetDetailPanel show={false} />);
      expect(screen.queryByRole('main')).not.toBeInTheDocument();

      rerender(<AssetDetailPanel show={true} />);
      expect(screen.getByRole('main', { hidden: true })).toBeInTheDocument();
    });
  });
  ...
  describe('Performance', () => {
    it('should memoize expensive computations', () => {
      ...
      render(<AssetDetailPanel compute={expensiveFunction} />);

      expect(expensiveFunction).toHaveBeenCalledTimes(1);
    });

    it('should not re-render unnecessarily', () => {
      const { rerender } = render(<AssetDetailPanel value="test" />);
      const renderCount = vi.fn();

      rerender(<AssetDetailPanel value="test" />);
  ...
  describe('Security', () => {
    it('should sanitize user input', () => {
      ...
      render(<AssetDetailPanel value={maliciousInput} />);
    ...
    it('should escape HTML entities', () => {
      ...
      render(<AssetDetailPanel value={htmlInput} />);
