...
describe('GlobalCommandPalette', () => {
  ...
  describe('Rendering', () => {
    it('should render without crashing', () => {
      const { container } = render(<GlobalCommandPalette />);
  ...
  describe('Props', () => {
    it('should accept and apply className prop', () => {
      const { container } = render(<GlobalCommandPalette className="test-class" />);
      expect(container.firstChild).toHaveClass('test-class');
    });

    it('should handle data attributes', () => {
      const { container } = render(<GlobalCommandPalette data-testid="test-component" />);
      expect(container.firstChild).toHaveAttribute('data-testid', 'test-component');
    });

    it('should render with custom props', () => {
      const customProps = { title: 'Test Title' };
      render(<GlobalCommandPalette {...customProps} />);
  ...
  describe('User Interactions', () => {
    it('should handle click events', async () => {
      ...
      render(<GlobalCommandPalette onClick={handleClick} />);
    ...
    it('should handle keyboard events', async () => {
      ...
      render(<GlobalCommandPalette onKeyDown={handleKeyDown} />);
    ...
    it('should handle form submission', async () => {
      ...
      render(<GlobalCommandPalette onSubmit={handleSubmit} />);
  ...
  describe('Error Handling', () => {
    it('should handle errors gracefully', () => {
      ...
      render(<GlobalCommandPalette invalidProp={undefined} />);
    ...
    it('should display error messages', () => {
      render(<GlobalCommandPalette error="Test error" />);
  ...
  describe('Conditional Rendering', () => {
    it('should render when condition is met', () => {
      render(<GlobalCommandPalette show={true} />);
      expect(screen.getByRole('main', { hidden: true })).toBeInTheDocument();
    });

    it('should not render when condition is not met', () => {
      const { container } = render(<GlobalCommandPalette show={false} />);
      expect(container.firstChild).toBeNull();
    });

    it('should toggle visibility', async () => {
      const { rerender } = render(<GlobalCommandPalette show={false} />);
      expect(screen.queryByRole('main')).not.toBeInTheDocument();

      rerender(<GlobalCommandPalette show={true} />);
      expect(screen.getByRole('main', { hidden: true })).toBeInTheDocument();
    });
  });
  ...
  describe('Performance', () => {
    it('should memoize expensive computations', () => {
      ...
      render(<GlobalCommandPalette compute={expensiveFunction} />);

      expect(expensiveFunction).toHaveBeenCalledTimes(1);
    });

    it('should not re-render unnecessarily', () => {
      const { rerender } = render(<GlobalCommandPalette value="test" />);
      const renderCount = vi.fn();

      rerender(<GlobalCommandPalette value="test" />);
  ...
  describe('Security', () => {
    it('should sanitize user input', () => {
      ...
      render(<GlobalCommandPalette value={maliciousInput} />);
    ...
    it('should escape HTML entities', () => {
      ...
      render(<GlobalCommandPalette value={htmlInput} />);
