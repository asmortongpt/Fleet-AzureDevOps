...
import { DynamicLighting } from '../../components/garage/environment/index';
...
describe('DynamicLighting', () => {
  ...
  describe('Rendering', () => {
    it('should render without crashing', () => {
      const { container } = render(<DynamicLighting />);
      expect(container).toBeTruthy();
    });

    it('should render with default props', () => {
      render(<DynamicLighting />);
  ...
  describe('Props', () => {
    it('should accept and apply className prop', () => {
      const { container } = render(<DynamicLighting className="test-class" />);
      expect(container.firstChild).toHaveClass('test-class');
    });

    it('should handle data attributes', () => {
      const { container } = render(<DynamicLighting data-testid="test-component" />);
      expect(container.firstChild).toHaveAttribute('data-testid', 'test-component');
    });

    it('should render with custom props', () => {
      const customProps = { title: 'Test Title' };
      render(<DynamicLighting {...customProps} />);
  ...
  describe('User Interactions', () => {
    it('should handle click events', async () => {
      ...
      render(<DynamicLighting onClick={handleClick} />);
    ...
    it('should handle keyboard events', async () => {
      ...
      render(<DynamicLighting onKeyDown={handleKeyDown} />);
    ...
    it('should handle form submission', async () => {
      ...
      render(<DynamicLighting onSubmit={handleSubmit} />);
  ...
  describe('State Management', () => {
    ...
    it('should maintain internal state', () => {
      const { rerender } = render(<DynamicLighting />);
      rerender(<DynamicLighting />);
  ...
  describe('Error Handling', () => {
    it('should handle errors gracefully', () => {
      ...
      render(<DynamicLighting invalidProp={undefined} />);
    ...
    it('should display error messages', () => {
      render(<DynamicLighting error="Test error" />);
  ...
  describe('Conditional Rendering', () => {
    it('should render when condition is met', () => {
      render(<DynamicLighting show={true} />);
      expect(screen.getByRole('main', { hidden: true })).toBeInTheDocument();
    });

    it('should not render when condition is not met', () => {
      const { container } = render(<DynamicLighting show={false} />);
      expect(container.firstChild).toBeNull();
    });

    it('should toggle visibility', async () => {
      const { rerender } = render(<DynamicLighting show={false} />);
      expect(screen.queryByRole('main')).not.toBeInTheDocument();

      rerender(<DynamicLighting show={true} />);
      expect(screen.getByRole('main', { hidden: true })).toBeInTheDocument();
    });
  });
  ...
  describe('Performance', () => {
    it('should memoize expensive computations', () => {
      ...
      render(<DynamicLighting compute={expensiveFunction} />);

      expect(expensiveFunction).toHaveBeenCalledTimes(1);
    });

    it('should not re-render unnecessarily', () => {
      const { rerender } = render(<DynamicLighting value="test" />);
      const renderCount = vi.fn();

      rerender(<DynamicLighting value="test" />);
  ...
  describe('Security', () => {
    it('should sanitize user input', () => {
      ...
      render(<DynamicLighting value={maliciousInput} />);
    ...
    it('should escape HTML entities', () => {
      ...
      render(<DynamicLighting value={htmlInput} />);
