...
describe('ErrorHandlingExample', () => {
  ...
  describe('Props', () => {
    it('should accept and apply className prop', () => {
      const { container } = render(<ErrorHandlingExample className="test-class" />);
      expect(container.firstChild).toHaveClass('test-class');
    });

    it('should handle data attributes', () => {
      const { container } = render(<ErrorHandlingExample data-testid="test-component" />);
      expect(container.firstChild).toHaveAttribute('data-testid', 'test-component');
    });

    it('should render with custom props', () => {
      const customProps = { title: 'Test Title' };
      render(<ErrorHandlingExample {...customProps} />);
  ...
  describe('User Interactions', () => {
    it('should handle click events', async () => {
      ...
      render(<ErrorHandlingExample onClick={handleClick} />);
    ...
    it('should handle keyboard events', async () => {
      ...
      render(<ErrorHandlingExample onKeyDown={handleKeyDown} />);
    ...
    it('should handle form submission', async () => {
      ...
      render(<ErrorHandlingExample onSubmit={handleSubmit} />);
  ...
  describe('State Management', () => {
    ...
    it('should maintain internal state', () => {
      const { rerender } = render(<ErrorHandlingExample />);
      rerender(<ErrorHandlingExample />);
  ...
  describe('Error Handling', () => {
    it('should handle errors gracefully', () => {
      ...
      render(<ErrorHandlingExample invalidProp={undefined} />);
    ...
    it('should display error messages', () => {
      render(<ErrorHandlingExample error="Test error" />);
  ...
  describe('Conditional Rendering', () => {
    it('should render when condition is met', () => {
      render(<ErrorHandlingExample show={true} />);
      expect(screen.getByRole('main', { hidden: true })).toBeInTheDocument();
    });

    it('should not render when condition is not met', () => {
      const { container } = render(<ErrorHandlingExample show={false} />);
      expect(container.firstChild).toBeNull();
    });

    it('should toggle visibility', async () => {
      const { rerender } = render(<ErrorHandlingExample show={false} />);
      expect(screen.queryByRole('main')).not.toBeInTheDocument();

      rerender(<ErrorHandlingExample show={true} />);
      expect(screen.getByRole('main', { hidden: true })).toBeInTheDocument();
    });
  });
  ...
  describe('Performance', () => {
    it('should memoize expensive computations', () => {
      ...
      render(<ErrorHandlingExample compute={expensiveFunction} />);

      expect(expensiveFunction).toHaveBeenCalledTimes(1);
    });

    it('should not re-render unnecessarily', () => {
      const { rerender } = render(<ErrorHandlingExample value="test" />);
      const renderCount = vi.fn();

      rerender(<ErrorHandlingExample value="test" />);
  ...
  describe('Security', () => {
    it('should sanitize user input', () => {
      ...
      render(<ErrorHandlingExample value={maliciousInput} />);
    ...
    it('should escape HTML entities', () => {
      ...
      render(<ErrorHandlingExample value={htmlInput} />);
