...
describe('ConversationalIntake', () => {
  ...
  describe('Rendering', () => {
    it('should render without crashing', () => {
      const { container } = render(<ConversationalIntake />);
      expect(container).toBeTruthy();
    });

    it('should render with default props', () => {
      render(<ConversationalIntake />);
  ...
  describe('Props', () => {
    it('should accept and apply className prop', () => {
      const { container } = render(<ConversationalIntake className="test-class" />);
      expect(container.firstChild).toHaveClass('test-class');
    });

    it('should handle data attributes', () => {
      const { container } = render(<ConversationalIntake data-testid="test-component" />);
      expect(container.firstChild).toHaveAttribute('data-testid', 'test-component');
    });

    it('should render with custom props', () => {
      const customProps = { title: 'Test Title' };
      render(<ConversationalIntake {...customProps} />);
  ...
  describe('User Interactions', () => {
    it('should handle click events', async () => {
      ...
      render(<ConversationalIntake onClick={handleClick} />);
    ...
    it('should handle keyboard events', async () => {
      ...
      render(<ConversationalIntake onKeyDown={handleKeyDown} />);
    ...
    it('should handle form submission', async () => {
      ...
      render(<ConversationalIntake onSubmit={handleSubmit} />);
  ...
  describe('State Management', () => {
    ...
    it('should maintain internal state', () => {
      const { rerender } = render(<ConversationalIntake />);
      rerender(<ConversationalIntake />);
  ...
  describe('Error Handling', () => {
    it('should handle errors gracefully', () => {
      ...
      render(<ConversationalIntake invalidProp={undefined} />);
    ...
    it('should display error messages', () => {
      render(<ConversationalIntake error="Test error" />);
  ...
  describe('Conditional Rendering', () => {
    it('should render when condition is met', () => {
      render(<ConversationalIntake show={true} />);
      expect(screen.getByRole('main', { hidden: true })).toBeInTheDocument();
    });

    it('should not render when condition is not met', () => {
      const { container } = render(<ConversationalIntake show={false} />);
      expect(container.firstChild).toBeNull();
    });

    it('should toggle visibility', async () => {
      const { rerender } = render(<ConversationalIntake show={false} />);
      expect(screen.queryByRole('main')).not.toBeInTheDocument();

      rerender(<ConversationalIntake show={true} />);
      expect(screen.getByRole('main', { hidden: true })).toBeInTheDocument();
    });
  });
  ...
  describe('Performance', () => {
    it('should memoize expensive computations', () => {
      ...
      render(<ConversationalIntake compute={expensiveFunction} />);

      expect(expensiveFunction).toHaveBeenCalledTimes(1);
    });

    it('should not re-render unnecessarily', () => {
      const { rerender } = render(<ConversationalIntake value="test" />);
      const renderCount = vi.fn();

      rerender(<ConversationalIntake value="test" />);
  ...
  describe('Security', () => {
    it('should sanitize user input', () => {
      ...
      render(<ConversationalIntake value={maliciousInput} />);
    ...
    it('should escape HTML entities', () => {
      ...
      render(<ConversationalIntake value={htmlInput} />);
