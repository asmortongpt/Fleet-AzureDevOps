...
describe('LoadingSpinner', () => {
  ...
  describe('Props', () => {
    ...
    it('should handle data attributes', () => {
      const { container } = render(<LoadingSpinner data-testid="test-component" />);
  ...
  describe('User Interactions', () => {
    ...
    it('should handle keyboard events', async () => {
      ...
      render(<LoadingSpinner onKeyDown={handleKeyDown} />);
    ...
    it('should handle form submission', async () => {
      ...
      render(<LoadingSpinner onSubmit={handleSubmit} />);
  ...
  describe('Error Handling', () => {
    it('should handle errors gracefully', () => {
      ...
      render(<LoadingSpinner invalidProp={undefined} />);
    ...
    it('should display error messages', () => {
      render(<LoadingSpinner error="Test error" />);
  ...
  describe('Conditional Rendering', () => {
    ...
    it('should toggle visibility', async () => {
      const { rerender } = render(<LoadingSpinner show={false} />);
  ...
  describe('Performance', () => {
    it('should memoize expensive computations', () => {
      ...
      render(<LoadingSpinner compute={expensiveFunction} />);

      expect(expensiveFunction).toHaveBeenCalledTimes(1);
    });

    it('should not re-render unnecessarily', () => {
      const { rerender } = render(<LoadingSpinner value="test" />);
      const renderCount = vi.fn();

      rerender(<LoadingSpinner value="test" />);
  ...
  describe('Security', () => {
    it('should sanitize user input', () => {
      ...
      render(<LoadingSpinner value={maliciousInput} />);
    ...
    it('should escape HTML entities', () => {
      ...
      render(<LoadingSpinner value={htmlInput} />);
