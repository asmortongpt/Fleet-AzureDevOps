...
describe('CreateDamageReport', () => {
  ...
  describe('Rendering', () => {
    it('should render without crashing', () => {
      const { container } = render(<CreateDamageReport />);
      expect(container).toBeTruthy();
    });

    it('should render with default props', () => {
      render(<CreateDamageReport />);
  ...
  describe('Props', () => {
    it('should accept and apply className prop', () => {
      const { container } = render(<CreateDamageReport className="test-class" />);
      expect(container.firstChild).toHaveClass('test-class');
    });

    it('should handle data attributes', () => {
      const { container } = render(<CreateDamageReport data-testid="test-component" />);
      expect(container.firstChild).toHaveAttribute('data-testid', 'test-component');
    });

    it('should render with custom props', () => {
      const customProps = { title: 'Test Title' };
      render(<CreateDamageReport {...customProps} />);
  ...
  describe('User Interactions', () => {
    it('should handle click events', async () => {
      ...
      render(<CreateDamageReport onClick={handleClick} />);
    ...
    it('should handle keyboard events', async () => {
      ...
      render(<CreateDamageReport onKeyDown={handleKeyDown} />);
    ...
    it('should handle form submission', async () => {
      ...
      render(<CreateDamageReport onSubmit={handleSubmit} />);
  ...
  describe('State Management', () => {
    ...
    it('should maintain internal state', () => {
      const { rerender } = render(<CreateDamageReport />);
      rerender(<CreateDamageReport />);
  ...
  describe('Error Handling', () => {
    it('should handle errors gracefully', () => {
      ...
      render(<CreateDamageReport invalidProp={undefined} />);
    ...
    it('should display error messages', () => {
      render(<CreateDamageReport error="Test error" />);
  ...
  describe('Conditional Rendering', () => {
    it('should render when condition is met', () => {
      render(<CreateDamageReport show={true} />);
      expect(screen.getByRole('main', { hidden: true })).toBeInTheDocument();
    });

    it('should not render when condition is not met', () => {
      const { container } = render(<CreateDamageReport show={false} />);
      expect(container.firstChild).toBeNull();
    });

    it('should toggle visibility', async () => {
      const { rerender } = render(<CreateDamageReport show={false} />);
      expect(screen.queryByRole('main')).not.toBeInTheDocument();

      rerender(<CreateDamageReport show={true} />);
      expect(screen.getByRole('main', { hidden: true })).toBeInTheDocument();
    });
  });
  ...
  describe('Performance', () => {
    it('should memoize expensive computations', () => {
      ...
      render(<CreateDamageReport compute={expensiveFunction} />);

      expect(expensiveFunction).toHaveBeenCalledTimes(1);
    });

    it('should not re-render unnecessarily', () => {
      const { rerender } = render(<CreateDamageReport value="test" />);
      const renderCount = vi.fn();

      rerender(<CreateDamageReport value="test" />);
  ...
  describe('Security', () => {
    it('should sanitize user input', () => {
      ...
      render(<CreateDamageReport value={maliciousInput} />);
    ...
    it('should escape HTML entities', () => {
      ...
      render(<CreateDamageReport value={htmlInput} />);
