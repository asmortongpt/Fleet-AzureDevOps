...
describe('VehicleDetailPanel', () => {
  ...
  describe('Rendering', () => {
    it('should render without crashing', () => {
      const { container } = render(<VehicleDetailPanel />);
      expect(container).toBeTruthy();
    });

    it('should render with default props', () => {
      render(<VehicleDetailPanel />);
  ...
  describe('Props', () => {
    it('should accept and apply className prop', () => {
      const { container } = render(<VehicleDetailPanel className="test-class" />);
      expect(container.firstChild).toHaveClass('test-class');
    });

    it('should handle data attributes', () => {
      const { container } = render(<VehicleDetailPanel data-testid="test-component" />);
      expect(container.firstChild).toHaveAttribute('data-testid', 'test-component');
    });

    it('should render with custom props', () => {
      const customProps = { title: 'Test Title' };
      render(<VehicleDetailPanel {...customProps} />);
  ...
  describe('User Interactions', () => {
    it('should handle click events', async () => {
      ...
      render(<VehicleDetailPanel onClick={handleClick} />);
    ...
    it('should handle keyboard events', async () => {
      ...
      render(<VehicleDetailPanel onKeyDown={handleKeyDown} />);
    ...
    it('should handle form submission', async () => {
      ...
      render(<VehicleDetailPanel onSubmit={handleSubmit} />);
  ...
  describe('State Management', () => {
    ...
    it('should maintain internal state', () => {
      const { rerender } = render(<VehicleDetailPanel />);
      rerender(<VehicleDetailPanel />);
  ...
  describe('Error Handling', () => {
    it('should handle errors gracefully', () => {
      ...
      render(<VehicleDetailPanel invalidProp={undefined} />);
    ...
    it('should display error messages', () => {
      render(<VehicleDetailPanel error="Test error" />);
  ...
  describe('Conditional Rendering', () => {
    it('should render when condition is met', () => {
      render(<VehicleDetailPanel show={true} />);
      expect(screen.getByRole('main', { hidden: true })).toBeInTheDocument();
    });

    it('should not render when condition is not met', () => {
      const { container } = render(<VehicleDetailPanel show={false} />);
      expect(container.firstChild).toBeNull();
    });

    it('should toggle visibility', async () => {
      const { rerender } = render(<VehicleDetailPanel show={false} />);
      expect(screen.queryByRole('main')).not.toBeInTheDocument();

      rerender(<VehicleDetailPanel show={true} />);
      expect(screen.getByRole('main', { hidden: true })).toBeInTheDocument();
    });
  });
  ...
  describe('Performance', () => {
    it('should memoize expensive computations', () => {
      ...
      render(<VehicleDetailPanel compute={expensiveFunction} />);

      expect(expensiveFunction).toHaveBeenCalledTimes(1);
    });

    it('should not re-render unnecessarily', () => {
      const { rerender } = render(<VehicleDetailPanel value="test" />);
      const renderCount = vi.fn();

      rerender(<VehicleDetailPanel value="test" />);
  ...
  describe('Security', () => {
    it('should sanitize user input', () => {
      ...
      render(<VehicleDetailPanel value={maliciousInput} />);
    ...
    it('should escape HTML entities', () => {
      ...
      render(<VehicleDetailPanel value={htmlInput} />);
