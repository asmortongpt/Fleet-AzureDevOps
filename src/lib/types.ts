...
export interface Vehicle {
  ...
  vin: string
  licensePlate: string
  status: "active" | "idle" | "charging" | "service" | "emergency" | "offline" | "assigned" | "dispatched" | "en_route" | "on_site" | "completed" | "maintenance" | "retired"
  location: {
    lat: number
    lng: number
  ...
  // See: src/types/asset.types.ts for detailed type definitions
  // Migration: api/src/migrations/032_multi_asset_vehicle_extensions.sql
  // ============================================================================
  ...
  asset_type?: string // See AssetType in asset.types.ts for full list (30+ types)
