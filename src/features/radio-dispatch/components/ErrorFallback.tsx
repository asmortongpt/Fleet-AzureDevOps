          ...
          <div className="p-6 space-y-6">
              ...
              <div className="space-y-2">
                ...
                {showDetails && (
                  <div className="bg-muted/50 rounded-md p-4 border border-border">
                    ...
                    {error?.stack && (
                      <>
                        <h3 className="text-sm font-medium text-foreground mt-4 mb-2">Stack Trace</h3>
                        <pre className="text-xs text-muted-foreground font-mono overflow-x-auto whitespace-pre-wrap">
                          {error.stack}
                        </pre>
                      </>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <button
                ...
                className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-primary text-primary-foreground rounded-md hover:bg-primary/90 transition-colors font-medium focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
              >
              ...
              <button
                ...
                className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-secondary text-secondary-foreground rounded-md hover:bg-secondary/80 transition-colors font-medium focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
              >
