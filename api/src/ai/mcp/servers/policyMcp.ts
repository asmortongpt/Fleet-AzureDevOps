...
return { ok: true, result: { matches: [] } };
    ...
    if (toolName === "getControl") {
return { ok: true, result: { controlId: args.controlId, text: "TODO" } };
}
    if (toolName === "validateAction") {
return { ok: true, result: { allowed: true, reason: "TODO" } };
}
