...
-- CREATE INDEX IF NOT EXISTS idx_skipped_status);
-- -- CREATE INDEX IF NOT EXISTS idx_skipped_status) WHERE facility_id IS NOT NULL;
...
-- CREATE INDEX IF NOT EXISTS idx_inspections_vehicle_id ON inspections(assigned_vehicle_id);
-- CREATE INDEX IF NOT EXISTS idx_inspections_driver_id ON inspections(assigned_driver_id) WHERE assigned_driver_id IS NOT NULL;
...
-- CREATE INDEX IF NOT EXISTS idx_fuel_transactions_vehicle_id ON fuel_transactions(assigned_vehicle_id);
-- CREATE INDEX IF NOT EXISTS idx_fuel_transactions_driver_id ON fuel_transactions(assigned_driver_id) WHERE assigned_driver_id IS NOT NULL;
...
-- Foreign key indexes
-- CREATE INDEX IF NOT EXISTS idx_incidents_safety_tenant_id ON incidents(tenant_id);
-- CREATE INDEX IF NOT EXISTS idx_incidents_safety_vehicle_id ON incidents(vehicle_id) WHERE vehicle_id IS NOT NULL;
-- CREATE INDEX IF NOT EXISTS idx_incidents_safety_driver_id ON incidents(driver_id) WHERE driver_id IS NOT NULL;

-- Filter indexes
-- CREATE INDEX IF NOT EXISTS idx_incidents_safety_severity ON incidents(severity);
-- -- CREATE INDEX IF NOT EXISTS idx_skipped_status);

-- Composite indexes
-- CREATE INDEX IF NOT EXISTS idx_incidents_safety_tenant_severity ON incidents(tenant_id, severity);

-- Timestamp indexes
-- CREATE INDEX IF NOT EXISTS idx_incidents_safety_incident_date ON incidents(incident_date DESC);
...
-- CREATE INDEX IF NOT EXISTS idx_damage_reports_vehicle_id ON damage_reports(assigned_vehicle_id);
-- CREATE INDEX IF NOT EXISTS idx_damage_reports_driver_id ON damage_reports(assigned_driver_id) WHERE assigned_driver_id IS NOT NULL;
...
-- Foreign key indexes
-- CREATE INDEX IF NOT EXISTS idx_geofence_events_vehicle_id ON geofence_events(assigned_vehicle_id);
-- CREATE INDEX IF NOT EXISTS idx_geofence_events_geofence_id ON geofence_events(geofence_id);
-- CREATE INDEX IF NOT EXISTS idx_geofence_events_driver_id ON geofence_events(assigned_driver_id) WHERE assigned_driver_id IS NOT NULL;
...
-- CREATE INDEX IF NOT EXISTS idx_charging_sessions_vehicle_id ON charging_sessions(assigned_vehicle_id);
...
-- -- CREATE INDEX IF NOT EXISTS idx_skipped_status) WHERE EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'documents');
...
-- -- CREATE INDEX IF NOT EXISTS idx_skipped_status) WHERE EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'audit_logs');
...
-- CREATE INDEX IF NOT EXISTS idx_routes_assigned_vehicle_id ON routes(assigned_assigned_vehicle_id) WHERE assigned_vehicle_id IS NOT NULL;
-- CREATE INDEX IF NOT EXISTS idx_routes_assigned_driver_id ON routes(assigned_assigned_driver_id) WHERE assigned_driver_id IS NOT NULL;
