...
describe('VehicleService', () => {
  describe('getVehicle', () => {
    it('should return a vehicle', async () => {
      ...
      vi.spyOn(vehicleService, 'fetchVehicleFromDatabase').mockResolvedValue(mockVehicle);
    ...
    it('should throw an error if fetching fails', async () => {
      vi.spyOn(vehicleService, 'fetchVehicleFromDatabase').mockRejectedValue(new Error('Database error'));
