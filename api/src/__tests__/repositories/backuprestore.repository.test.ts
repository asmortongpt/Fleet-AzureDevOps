...
import { pool } from '../../db';
import { BackupRestoreRepository } from '../../repositories/backuprestore.repository';
...
describe('BackupRestoreRepository', () => {
  let repository: BackupRestoreRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new BackupRestoreRepository();
    vi.clearAllMocks();
  });
