...
import { pool } from '../../db';
import { VehicleTelematicsRepository } from '../../repositories/vehicletelematics.repository';
...
describe('VehicleTelematicsRepository', () => {
  let repository: VehicleTelematicsRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new VehicleTelematicsRepository();
    vi.clearAllMocks();
  });
