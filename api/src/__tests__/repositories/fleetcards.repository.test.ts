...
import { pool } from '../../db';
import { FleetCardsRepository } from '../../repositories/fleetcards.repository';
...
describe('FleetCardsRepository', () => {
  let repository: FleetCardsRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new FleetCardsRepository();
    vi.clearAllMocks();
  });
