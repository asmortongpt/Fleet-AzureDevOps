...
import { pool } from '../../db';
import { ForecastModelsRepository } from '../../repositories/forecastmodels.repository';
...
describe('ForecastModelsRepository', () => {
  let repository: ForecastModelsRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new ForecastModelsRepository();
    vi.clearAllMocks();
  });
