...
import { pool } from '../../db';
import { ShiftManagementRepository } from '../../repositories/shiftmanagement.repository';
...
describe('ShiftManagementRepository', () => {
  let repository: ShiftManagementRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new ShiftManagementRepository();
    vi.clearAllMocks();
  });
