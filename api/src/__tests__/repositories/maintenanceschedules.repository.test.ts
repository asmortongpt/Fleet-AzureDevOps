...
import { pool } from '../../db';
import { MaintenanceSchedulesRepository } from '../../repositories/maintenanceschedules.repository';
...
describe('MaintenanceSchedulesRepository', () => {
  let repository: MaintenanceSchedulesRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new MaintenanceSchedulesRepository();
    vi.clearAllMocks();
  });
