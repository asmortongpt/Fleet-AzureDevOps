...
import { pool } from '../../db';
import { TripApprovalsRepository } from '../../repositories/tripapprovals.repository';
...
describe('TripApprovalsRepository', () => {
  let repository: TripApprovalsRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new TripApprovalsRepository();
    vi.clearAllMocks();
  });
