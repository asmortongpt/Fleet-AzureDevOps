...
import { pool } from '../../db';
import { VendorManagementRepository } from '../../repositories/vendormanagement.repository';
...
describe('VendorManagementRepository', () => {
  let repository: VendorManagementRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new VendorManagementRepository();
    vi.clearAllMocks();
  });
