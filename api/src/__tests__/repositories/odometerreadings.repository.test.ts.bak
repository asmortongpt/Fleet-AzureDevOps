...
import { pool } from '../../db';
import { OdometerReadingsRepository } from '../../repositories/odometerreadings.repository';
...
describe('OdometerReadingsRepository', () => {
  let repository: OdometerReadingsRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new OdometerReadingsRepository();
    vi.clearAllMocks();
  });
