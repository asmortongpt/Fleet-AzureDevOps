...
import { pool } from '../../db';
import { UtilizationReportsRepository } from '../../repositories/utilizationreports.repository';
...
describe('UtilizationReportsRepository', () => {
  let repository: UtilizationReportsRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new UtilizationReportsRepository();
    vi.clearAllMocks();
  });
