...
import { pool } from '../../db';
import { BoundaryAlertsRepository } from '../../repositories/boundaryalerts.repository';
...
describe('BoundaryAlertsRepository', () => {
  let repository: BoundaryAlertsRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new BoundaryAlertsRepository();
    vi.clearAllMocks();
  });
