...
import { pool } from '../../db';
import { ReimbursementRequestsRepository } from '../../repositories/reimbursementrequests.repository';
...
describe('ReimbursementRequestsRepository', () => {
  let repository: ReimbursementRequestsRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new ReimbursementRequestsRepository();
    vi.clearAllMocks();
  });
