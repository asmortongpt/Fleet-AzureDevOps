...
import { pool } from '../../db';
import { RecallManagementRepository } from '../../repositories/recallmanagement.repository';
...
describe('RecallManagementRepository', () => {
  let repository: RecallManagementRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new RecallManagementRepository();
    vi.clearAllMocks();
  });
