...
import { pool } from '../../db';
import { PartsInventoryRepository } from '../../repositories/partsinventory.repository';
...
describe('PartsInventoryRepository', () => {
  let repository: PartsInventoryRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new PartsInventoryRepository();
    vi.clearAllMocks();
  });
