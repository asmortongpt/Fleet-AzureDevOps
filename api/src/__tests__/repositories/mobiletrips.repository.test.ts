...
import { pool } from '../../db';
import { MobileTripsRepository } from '../../repositories/mobiletrips.repository';
...
describe('MobileTripsRepository', () => {
  let repository: MobileTripsRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new MobileTripsRepository();
    vi.clearAllMocks();
  });
