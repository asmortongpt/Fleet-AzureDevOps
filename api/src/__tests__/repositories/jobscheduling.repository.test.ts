...
import { pool } from '../../db';
import { JobSchedulingRepository } from '../../repositories/jobscheduling.repository';
...
describe('JobSchedulingRepository', () => {
  let repository: JobSchedulingRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new JobSchedulingRepository();
    vi.clearAllMocks();
  });
