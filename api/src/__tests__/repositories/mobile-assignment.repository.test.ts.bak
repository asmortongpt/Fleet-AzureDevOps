...
import { pool } from '../../db';
import { MobileAssignmentRepositoryImpl } from '../../repositories/mobile-assignment.repository';
...
describe('MobileAssignmentRepositoryImpl', () => {
  let repository: MobileAssignmentRepositoryImpl;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new MobileAssignmentRepositoryImpl();
    vi.clearAllMocks();
  });
