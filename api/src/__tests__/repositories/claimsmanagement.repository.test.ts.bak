...
import { pool } from '../../db';
import { ClaimsManagementRepository } from '../../repositories/claimsmanagement.repository';
...
describe('ClaimsManagementRepository', () => {
  let repository: ClaimsManagementRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new ClaimsManagementRepository();
    vi.clearAllMocks();
  });
