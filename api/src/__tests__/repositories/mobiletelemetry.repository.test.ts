...
import { pool } from '../../db';
import { MobileTelemetryRepository } from '../../repositories/mobiletelemetry.repository';
...
describe('MobileTelemetryRepository', () => {
  let repository: MobileTelemetryRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new MobileTelemetryRepository();
    vi.clearAllMocks();
  });
