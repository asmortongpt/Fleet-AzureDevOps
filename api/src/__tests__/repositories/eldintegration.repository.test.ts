...
import { pool } from '../../db';
import { EldIntegrationRepository } from '../../repositories/eldintegration.repository';
...
describe('EldIntegrationRepository', () => {
  let repository: EldIntegrationRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new EldIntegrationRepository();
    vi.clearAllMocks();
  });
