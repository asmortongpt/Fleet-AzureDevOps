...
import { pool } from '../../db';
import { SubscriptionmanagementRepository } from '../../repositories/subscriptionmanagement.repository';
...
describe('SubscriptionmanagementRepository', () => {
  let repository: SubscriptionmanagementRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new SubscriptionmanagementRepository();
    vi.clearAllMocks();
  });
