...
import { pool } from '../../db';
import { EquipmentTrackingRepository } from '../../repositories/equipmenttracking.repository';
...
describe('EquipmentTrackingRepository', () => {
  let repository: EquipmentTrackingRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new EquipmentTrackingRepository();
    vi.clearAllMocks();
  });
