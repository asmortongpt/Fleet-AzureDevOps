...
import { pool } from '../../db';
import { BatteryHealthRepository } from '../../repositories/batteryhealth.repository';
...
describe('BatteryHealthRepository', () => {
  let repository: BatteryHealthRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new BatteryHealthRepository();
    vi.clearAllMocks();
  });
