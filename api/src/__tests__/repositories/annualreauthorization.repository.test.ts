...
import { pool } from '../../db';
import { AnnualReauthorizationRepository } from '../../repositories/annualreauthorization.repository';
...
describe('AnnualReauthorizationRepository', () => {
  let repository: AnnualReauthorizationRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new AnnualReauthorizationRepository();
    vi.clearAllMocks();
  });
