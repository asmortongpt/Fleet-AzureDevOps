...
import { pool } from '../../db';
import { ComplianceReportsRepository } from '../../repositories/compliancereports.repository';
...
describe('ComplianceReportsRepository', () => {
  let repository: ComplianceReportsRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new ComplianceReportsRepository();
    vi.clearAllMocks();
  });
