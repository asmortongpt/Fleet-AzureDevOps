...
import { pool } from '../../db';
import { DtoComplianceRepository } from '../../repositories/dtocompliance.repository';
...
describe('DtoComplianceRepository', () => {
  let repository: DtoComplianceRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new DtoComplianceRepository();
    vi.clearAllMocks();
  });
