...
import { pool } from '../../db';
import { DispatchBoardRepository } from '../../repositories/dispatchboard.repository';
...
describe('DispatchBoardRepository', () => {
  let repository: DispatchBoardRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new DispatchBoardRepository();
    vi.clearAllMocks();
  });
