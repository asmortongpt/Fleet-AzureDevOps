...
import { pool } from '../../db';
import { VideoEventsRepository } from '../../repositories/videoevents.repository';
...
describe('VideoEventsRepository', () => {
  let repository: VideoEventsRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new VideoEventsRepository();
    vi.clearAllMocks();
  });
