...
import { pool } from '../../db';
import { EngineDiagnosticsRepository } from '../../repositories/enginediagnostics.repository';
...
describe('EngineDiagnosticsRepository', () => {
  let repository: EngineDiagnosticsRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new EngineDiagnosticsRepository();
    vi.clearAllMocks();
  });
