...
import { pool } from '../../db';
import { AnalyticsserviceRepository } from '../../repositories/analyticsservice.repository';
...
describe('AnalyticsserviceRepository', () => {
  let repository: AnalyticsserviceRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new AnalyticsserviceRepository();
    vi.clearAllMocks();
  });
