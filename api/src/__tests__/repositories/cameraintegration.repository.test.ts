...
import { pool } from '../../db';
import { CameraIntegrationRepository } from '../../repositories/cameraintegration.repository';
...
describe('CameraIntegrationRepository', () => {
  let repository: CameraIntegrationRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new CameraIntegrationRepository();
    vi.clearAllMocks();
  });
