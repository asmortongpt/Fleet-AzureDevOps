...
import { pool } from '../../db';
import { InspectionTemplatesRepository } from '../../repositories/inspectiontemplates.repository';
...
describe('InspectionTemplatesRepository', () => {
  let repository: InspectionTemplatesRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new InspectionTemplatesRepository();
    vi.clearAllMocks();
  });
