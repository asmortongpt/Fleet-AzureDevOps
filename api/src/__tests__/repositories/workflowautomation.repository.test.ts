...
import { pool } from '../../db';
import { WorkflowAutomationRepository } from '../../repositories/workflowautomation.repository';
...
describe('WorkflowAutomationRepository', () => {
  let repository: WorkflowAutomationRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new WorkflowAutomationRepository();
    vi.clearAllMocks();
  });
