...
import { pool } from '../../db';
import { FuelCardIntegrationRepository } from '../../repositories/fuelcardintegration.repository';
...
describe('FuelCardIntegrationRepository', () => {
  let repository: FuelCardIntegrationRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new FuelCardIntegrationRepository();
    vi.clearAllMocks();
  });
