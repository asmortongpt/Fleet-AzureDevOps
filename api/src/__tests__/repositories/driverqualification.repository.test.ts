...
import { pool } from '../../db';
import { DriverQualificationRepository } from '../../repositories/driverqualification.repository';
...
describe('DriverQualificationRepository', () => {
  let repository: DriverQualificationRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new DriverQualificationRepository();
    vi.clearAllMocks();
  });
