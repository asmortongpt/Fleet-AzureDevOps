...
import { pool } from '../../db';
import { ComplianceCalendarRepository } from '../../repositories/compliancecalendar.repository';
...
describe('ComplianceCalendarRepository', () => {
  let repository: ComplianceCalendarRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new ComplianceCalendarRepository();
    vi.clearAllMocks();
  });
