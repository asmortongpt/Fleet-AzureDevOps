...
import { pool } from '../../db';
import { TrainingRecordsRepository } from '../../repositories/trainingrecords.repository';
...
describe('TrainingRecordsRepository', () => {
  let repository: TrainingRecordsRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new TrainingRecordsRepository();
    vi.clearAllMocks();
  });
