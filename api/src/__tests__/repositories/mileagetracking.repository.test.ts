...
import { pool } from '../../db';
import { MileageTrackingRepository } from '../../repositories/mileagetracking.repository';
...
describe('MileageTrackingRepository', () => {
  let repository: MileageTrackingRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new MileageTrackingRepository();
    vi.clearAllMocks();
  });
