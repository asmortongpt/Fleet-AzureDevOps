...
import { pool } from '../../db';
import { CollisionDetectionRepository } from '../../repositories/collisiondetection.repository';
...
describe('CollisionDetectionRepository', () => {
  let repository: CollisionDetectionRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new CollisionDetectionRepository();
    vi.clearAllMocks();
  });
