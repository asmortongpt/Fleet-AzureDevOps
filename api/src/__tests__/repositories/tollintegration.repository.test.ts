...
import { pool } from '../../db';
import { TollIntegrationRepository } from '../../repositories/tollintegration.repository';
...
describe('TollIntegrationRepository', () => {
  let repository: TollIntegrationRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new TollIntegrationRepository();
    vi.clearAllMocks();
  });
