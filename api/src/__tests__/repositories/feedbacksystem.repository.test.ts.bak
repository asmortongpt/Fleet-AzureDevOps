...
import { pool } from '../../db';
import { FeedbackSystemRepository } from '../../repositories/feedbacksystem.repository';
...
describe('FeedbackSystemRepository', () => {
  let repository: FeedbackSystemRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new FeedbackSystemRepository();
    vi.clearAllMocks();
  });
