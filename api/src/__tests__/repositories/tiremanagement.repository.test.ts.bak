...
import { pool } from '../../db';
import { TireManagementRepository } from '../../repositories/tiremanagement.repository';
...
describe('TireManagementRepository', () => {
  let repository: TireManagementRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new TireManagementRepository();
    vi.clearAllMocks();
  });
