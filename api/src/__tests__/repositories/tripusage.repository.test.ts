...
import { pool } from '../../db';
import { TripUsageRepository } from '../../repositories/tripusage.repository';
...
describe('TripUsageRepository', () => {
  let repository: TripUsageRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new TripUsageRepository();
    vi.clearAllMocks();
  });
