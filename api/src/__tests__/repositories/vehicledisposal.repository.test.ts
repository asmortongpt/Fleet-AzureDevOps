...
import { pool } from '../../db';
import { VehicleDisposalRepository } from '../../repositories/vehicledisposal.repository';
...
describe('VehicleDisposalRepository', () => {
  let repository: VehicleDisposalRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new VehicleDisposalRepository();
    vi.clearAllMocks();
  });
