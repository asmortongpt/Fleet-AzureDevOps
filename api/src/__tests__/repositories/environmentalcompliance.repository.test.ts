...
import { pool } from '../../db';
import { EnvironmentalcomplianceRepository } from '../../repositories/environmentalcompliance.repository';
...
describe('EnvironmentalcomplianceRepository', () => {
  let repository: EnvironmentalcomplianceRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new EnvironmentalcomplianceRepository();
    vi.clearAllMocks();
  });
