...
import { pool } from '../../db';
import { TripManagementRepository } from '../../repositories/tripmanagement.repository';
...
describe('TripManagementRepository', () => {
  let repository: TripManagementRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new TripManagementRepository();
    vi.clearAllMocks();
  });
