...
import { pool } from '../../db';
import { RouteOptimizationRepository } from '../../repositories/routeoptimization.repository';
...
describe('RouteOptimizationRepository', () => {
  let repository: RouteOptimizationRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new RouteOptimizationRepository();
    vi.clearAllMocks();
  });
