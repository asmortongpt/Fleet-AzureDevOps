...
import { pool } from '../../db';
import { IdleTimeTrackingRepository } from '../../repositories/idletimetracking.repository';
...
describe('IdleTimeTrackingRepository', () => {
  let repository: IdleTimeTrackingRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new IdleTimeTrackingRepository();
    vi.clearAllMocks();
  });
