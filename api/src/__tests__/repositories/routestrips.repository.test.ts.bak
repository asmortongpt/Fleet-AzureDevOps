...
import { pool } from '../../db';
import { RoutesTripsRepository } from '../../repositories/routestrips.repository';
...
describe('RoutesTripsRepository', () => {
  let repository: RoutesTripsRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new RoutesTripsRepository();
    vi.clearAllMocks();
  });
