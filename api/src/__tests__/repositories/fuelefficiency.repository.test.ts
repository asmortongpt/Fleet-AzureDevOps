...
import { pool } from '../../db';
import { FuelEfficiencyRepository } from '../../repositories/fuelefficiency.repository';
...
describe('FuelEfficiencyRepository', () => {
  let repository: FuelEfficiencyRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new FuelEfficiencyRepository();
    vi.clearAllMocks();
  });
