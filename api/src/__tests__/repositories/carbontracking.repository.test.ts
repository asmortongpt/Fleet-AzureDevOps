...
import { pool } from '../../db';
import { CarbonTrackingRepository } from '../../repositories/carbontracking.repository';
...
describe('CarbonTrackingRepository', () => {
  let repository: CarbonTrackingRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new CarbonTrackingRepository();
    vi.clearAllMocks();
  });
