...
import { pool } from '../../db';
import { SpeedViolationsRepository } from '../../repositories/speedviolations.repository';
...
describe('SpeedViolationsRepository', () => {
  let repository: SpeedViolationsRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new SpeedViolationsRepository();
    vi.clearAllMocks();
  });
