...
import { pool } from '../../db';
import { LeaseTrackingRepository } from '../../repositories/leasetracking.repository';
...
describe('LeaseTrackingRepository', () => {
  let repository: LeaseTrackingRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new LeaseTrackingRepository();
    vi.clearAllMocks();
  });
