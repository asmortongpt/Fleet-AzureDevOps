...
import { pool } from '../../db';
import { MobileLoggingRepository } from '../../repositories/mobilelogging.repository';
...
describe('MobileLoggingRepository', () => {
  let repository: MobileLoggingRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new MobileLoggingRepository();
    vi.clearAllMocks();
  });
