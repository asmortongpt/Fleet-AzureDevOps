...
import { pool } from '../../db';
import { IntegrationLogsRepository } from '../../repositories/integrationlogs.repository';
...
describe('IntegrationLogsRepository', () => {
  let repository: IntegrationLogsRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new IntegrationLogsRepository();
    vi.clearAllMocks();
  });
