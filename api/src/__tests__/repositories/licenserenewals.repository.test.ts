...
import { pool } from '../../db';
import { LicenseRenewalsRepository } from '../../repositories/licenserenewals.repository';
...
describe('LicenseRenewalsRepository', () => {
  let repository: LicenseRenewalsRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new LicenseRenewalsRepository();
    vi.clearAllMocks();
  });
