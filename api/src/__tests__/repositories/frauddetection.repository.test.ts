...
import { pool } from '../../db';
import { FraudDetectionRepository } from '../../repositories/frauddetection.repository';
...
describe('FraudDetectionRepository', () => {
  let repository: FraudDetectionRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new FraudDetectionRepository();
    vi.clearAllMocks();
  });
