...
import { pool } from '../../db';
import { PersonalusepoliciesRepository } from '../../repositories/personalusepolicies.repository';
...
describe('PersonalusepoliciesRepository', () => {
  let repository: PersonalusepoliciesRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new PersonalusepoliciesRepository();
    vi.clearAllMocks();
  });
