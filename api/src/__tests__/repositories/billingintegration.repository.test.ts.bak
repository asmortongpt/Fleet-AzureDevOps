...
import { pool } from '../../db';
import { BillingIntegrationRepository } from '../../repositories/billingintegration.repository';
...
describe('BillingIntegrationRepository', () => {
  let repository: BillingIntegrationRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new BillingIntegrationRepository();
    vi.clearAllMocks();
  });
