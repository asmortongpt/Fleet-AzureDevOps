...
import { pool } from '../../db';
import { FleetanalyticsRepository } from '../../repositories/fleetanalytics.repository';
...
describe('FleetanalyticsRepository', () => {
  let repository: FleetanalyticsRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new FleetanalyticsRepository();
    vi.clearAllMocks();
  });
