...
import { pool } from '../../db';
import { InsurancePoliciesRepository } from '../../repositories/insurancepolicies.repository';
...
describe('InsurancePoliciesRepository', () => {
  let repository: InsurancePoliciesRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new InsurancePoliciesRepository();
    vi.clearAllMocks();
  });
