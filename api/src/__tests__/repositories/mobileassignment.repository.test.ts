...
import { pool } from '../../db';
import { MobileAssignmentRepository } from '../../repositories/mobileassignment.repository';
...
describe('MobileAssignmentRepository', () => {
  let repository: MobileAssignmentRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new MobileAssignmentRepository();
    vi.clearAllMocks();
  });
