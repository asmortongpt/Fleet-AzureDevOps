...
import { pool } from '../../db';
import { OncallmanagementRepository } from '../../repositories/oncallmanagement.repository';
...
describe('OncallmanagementRepository', () => {
  let repository: OncallmanagementRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new OncallmanagementRepository();
    vi.clearAllMocks();
  });
