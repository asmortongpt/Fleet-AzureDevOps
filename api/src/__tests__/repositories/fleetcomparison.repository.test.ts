...
import { pool } from '../../db';
import { FleetComparisonRepository } from '../../repositories/fleetcomparison.repository';
...
describe('FleetComparisonRepository', () => {
  let repository: FleetComparisonRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new FleetComparisonRepository();
    vi.clearAllMocks();
  });
