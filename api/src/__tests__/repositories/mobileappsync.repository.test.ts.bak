...
import { pool } from '../../db';
import { MobileAppSyncRepository } from '../../repositories/mobileappsync.repository';
...
describe('MobileAppSyncRepository', () => {
  let repository: MobileAppSyncRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new MobileAppSyncRepository();
    vi.clearAllMocks();
  });
