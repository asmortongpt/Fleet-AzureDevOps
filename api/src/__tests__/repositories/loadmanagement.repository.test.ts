...
import { pool } from '../../db';
import { LoadManagementRepository } from '../../repositories/loadmanagement.repository';
...
describe('LoadManagementRepository', () => {
  let repository: LoadManagementRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new LoadManagementRepository();
    vi.clearAllMocks();
  });
