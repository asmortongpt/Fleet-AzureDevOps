...
import { pool } from '../../db';
import { ServiceSchedulesRepository } from '../../repositories/serviceschedules.repository';
...
describe('ServiceSchedulesRepository', () => {
  let repository: ServiceSchedulesRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new ServiceSchedulesRepository();
    vi.clearAllMocks();
  });
