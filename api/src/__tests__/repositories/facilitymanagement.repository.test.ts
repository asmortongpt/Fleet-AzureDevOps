...
import { pool } from '../../db';
import { FacilityManagementRepository } from '../../repositories/facilitymanagement.repository';
...
describe('FacilityManagementRepository', () => {
  let repository: FacilityManagementRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new FacilityManagementRepository();
    vi.clearAllMocks();
  });
