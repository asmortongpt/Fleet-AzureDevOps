...
import { pool } from '../../db';
import { HealthMonitoringRepository } from '../../repositories/healthmonitoring.repository';
...
describe('HealthMonitoringRepository', () => {
  let repository: HealthMonitoringRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new HealthMonitoringRepository();
    vi.clearAllMocks();
  });
