...
import { pool } from '../../db';
import { BulkOperationsRepository } from '../../repositories/bulkoperations.repository';
...
describe('BulkOperationsRepository', () => {
  let repository: BulkOperationsRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new BulkOperationsRepository();
    vi.clearAllMocks();
  });
