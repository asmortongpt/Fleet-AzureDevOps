...
import { pool } from '../../db';
import { VehicleGroupsRepository } from '../../repositories/vehiclegroups.repository';
...
describe('VehicleGroupsRepository', () => {
  let repository: VehicleGroupsRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new VehicleGroupsRepository();
    vi.clearAllMocks();
  });
