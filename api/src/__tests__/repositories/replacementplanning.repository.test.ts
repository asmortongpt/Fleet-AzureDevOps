...
import { pool } from '../../db';
import { ReplacementPlanningRepository } from '../../repositories/replacementplanning.repository';
...
describe('ReplacementPlanningRepository', () => {
  let repository: ReplacementPlanningRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new ReplacementPlanningRepository();
    vi.clearAllMocks();
  });
