...
import { pool } from '../../db';
import { VehicleHistoryRepository } from '../../repositories/vehiclehistory.repository';
...
describe('VehicleHistoryRepository', () => {
  let repository: VehicleHistoryRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new VehicleHistoryRepository();
    vi.clearAllMocks();
  });
