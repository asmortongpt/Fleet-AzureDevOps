...
import { pool } from '../../db';
import { WarrantyTrackingRepository } from '../../repositories/warrantytracking.repository';
...
describe('WarrantyTrackingRepository', () => {
  let repository: WarrantyTrackingRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new WarrantyTrackingRepository();
    vi.clearAllMocks();
  });
