...
import { pool } from '../../db';
import { FuelTransactionsRepository } from '../../repositories/fuel-transactions.repository';
...
describe('FuelTransactionsRepository', () => {
  let repository: FuelTransactionsRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new FuelTransactionsRepository();
    vi.clearAllMocks();
  });
