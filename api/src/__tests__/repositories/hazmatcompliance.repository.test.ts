...
import { pool } from '../../db';
import { HazmatComplianceRepository } from '../../repositories/hazmatcompliance.repository';
...
describe('HazmatComplianceRepository', () => {
  let repository: HazmatComplianceRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new HazmatComplianceRepository();
    vi.clearAllMocks();
  });
