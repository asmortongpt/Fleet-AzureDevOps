...
import { pool } from '../../db';
import { CleaningSchedulesRepository } from '../../repositories/cleaningschedules.repository';
...
describe('CleaningSchedulesRepository', () => {
  let repository: CleaningSchedulesRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new CleaningSchedulesRepository();
    vi.clearAllMocks();
  });
