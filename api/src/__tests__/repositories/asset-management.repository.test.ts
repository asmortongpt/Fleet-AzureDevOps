...
import { pool } from '../../db';
import { AssetManagementRepository } from '../../repositories/asset-management.repository';
...
describe('AssetManagementRepository', () => {
  let repository: AssetManagementRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new AssetManagementRepository();
    vi.clearAllMocks();
  });
