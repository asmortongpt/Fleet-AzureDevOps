...
import { pool } from '../../db';
import { EventSubscriptionsRepository } from '../../repositories/eventsubscriptions.repository';
...
describe('EventSubscriptionsRepository', () => {
  let repository: EventSubscriptionsRepository;
  const mockTenantId = 1;

  beforeEach(() => {
    repository = new EventSubscriptionsRepository();
    vi.clearAllMocks();
  });
