...
export class AITaskPrioritizationService {
  ...
  try {
    ...
    const context = await gatherTaskContext(validatedTask)
...
Return ONLY valid JSON:
{
  ...
  "confidence": <0-100>
    ...
    return calculateBasicPriorityScore(taskData)
  }
}
 ...
 */
async function gatherTaskContext(taskData: z.infer<typeof TaskDataSchema>) {
  try {
 ...
 */
function calculateBasicPriorityScore(taskData: z.infer<typeof TaskDataSchema>): PriorityScore {
