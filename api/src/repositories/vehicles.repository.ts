...
export class VehiclesRepository extends BaseRepository<Vehicle> {
  ...
  private static readonly selectColumns = `
    ...
    pto_hours::numeric(10,2) AS "ptoHours",
    aux_hours::numeric(10,2) AS "auxHours",
    cycle_count AS "cycleCount",
    last_metric_update AS "lastMetricUpdate",
    capacity_tons::numeric(10,2) AS "capacityTons",
    max_reach_feet::numeric(10,2) AS "maxReachFeet",
    lift_height_feet::numeric(10,2) AS "liftHeightFeet",
    bucket_capacity_yards::numeric(10,2) AS "bucketCapacityYards",
    operating_weight_lbs::numeric(12,2) AS "operatingWeightLbs",
    axle_count AS "axleCount",
    max_payload_kg::numeric(12,2) AS "maxPayloadKg",
    tank_capacity_l::numeric(10,2) AS "tankCapacityL",
    has_pto AS "hasPto",
    has_aux_power AS "hasAuxPower",
    is_road_legal AS "isRoadLegal",
    requires_cdl AS "requiresCdl",
    requires_special_license AS "requiresSpecialLicense",
    max_speed_kph::numeric(5,2) AS "maxSpeedKph",
    is_off_road_only AS "isOffRoadOnly",
