...
/**
 * GET /ping - Simple ping endpoint for testing
 * Always returns 200 OK regardless of database connectivity
 * Use this for endpoint testing and basic connectivity checks
 */
