 ...
 * Retry a failed job
 */
router.post('/:queueName/retry/:jobId', async (req: Request, res: Response, next: NextFunction) => {
  try {
 ...
 */
router.delete('/:queueName/:jobId', async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { queueName, jobId } = req.params
 ...
 */
router.post('/:queueName/pause', async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { queueName } = req.params
 ...
 */
router.post('/:queueName/resume', async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { queueName } = req.params
 ...
 */
router.post('/:queueName/job/:jobId/promote', async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { queueName, jobId } = req.params
