...
router.post('/qr/generate/:vehicleId', requirePermission('vehicle:update:fleet'), qrGenerateLimiter, asyncHandler(async (req, res) => {
...
router.post('/qr/scan', requirePermission('vehicle:view:fleet'), qrScanLimiter, asyncHandler(async (req, res) => {
