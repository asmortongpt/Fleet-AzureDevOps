...
router.delete(
  '/:id',
 csrfProtection, requirePermission('maintenance_schedule:delete:fleet'),
  ...
  async (req: AuthRequest, res: Response) => {
    try {
      ...
      const telemetryResult = await pool.query(
        `SELECT id, tenant_id, vehicle_id, odometer_reading, engine_hours, fuel_level, battery_level, last_gps_location, snapshot_date, created_at FROM vehicle_telemetry_snapshots
