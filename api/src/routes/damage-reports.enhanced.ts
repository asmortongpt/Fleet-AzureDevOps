...
router.get(
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      const query = {
        text: `SELECT * FROM damage_repor WHERE tenant_id = $1 /* tenant_id validated */t WHERE tenant_id = $1 /* tenant_id validated */s WHERE /* TODO: Add tenant_id = $X AND */ vehicle_id = $1 ORDER BY created_at DESC LIMIT $2 OFFSET $3`,
