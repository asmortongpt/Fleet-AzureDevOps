...
/**
 * Integration tests for /arcgis-layers routes
 * Generated by: Agent 5 Test Generator
 * Coverage target: 100% of endpoints
 */

describe('/arcgis-layers API Integration Tests', () => {
  ...
  describe('GET /arcgis-layers/enabled/list', () => {
    it('should return data successfully', async () => {
      const response = await request(app)
        .get('/arcgis-layers/enabled/list')
  ...
  describe('GET /arcgis-layers/:id', () => {
    it('should return data successfully', async () => {
      const response = await request(app)
        .get('/arcgis-layers/:id')
  ...
  describe('PUT /arcgis-layers/:id', () => {
    it('should update resource successfully', async () => {
      const response = await request(app)
        .put('/arcgis-layers/:id')
  ...
  describe('DELETE /arcgis-layers/:id', () => {
    it('should delete resource successfully', async () => {
      const response = await request(app)
        .delete('/arcgis-layers/:id')
  ...
  describe('Tenant Isolation', () => {
    it('should prevent cross-tenant data access', async () => {
      ...
      const responseB = await request(app)
        .get(`/arcgis-layers/${resourceA.body.id}`)
