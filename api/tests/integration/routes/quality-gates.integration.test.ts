...
/**
 * Integration tests for /quality-gates routes
...
describe('/quality-gates API Integration Tests', () => {
  ...
  describe('GET /quality-gates/summary', () => {
    it('should return data successfully', async () => {
      const response = await request(app)
  ...
  describe('GET /quality-gates/latest/:gate_type', () => {
    it('should return data successfully', async () => {
      const response = await request(app)
        .get('/quality-gates/latest/:gate_type')
  ...
  describe('Tenant Isolation', () => {
    it('should prevent cross-tenant data access', async () => {
      ...
      const responseB = await request(app)
        .get(`/quality-gates/${resourceA.body.id}`)
