...
/**
 * Integration tests for /vehicles-refactored.example routes
 * Generated by: Agent 5 Test Generator
 * Coverage target: 100% of endpoints
 */

describe('/vehicles-refactored.example API Integration Tests', () => {
  ...
  describe('GET /vehicles-refactored.example/', () => {
    it('should return data successfully', async () => {
      const response = await request(app)
        .get('/vehicles-refactored.example/')
  ...
  describe('POST /vehicles-refactored.example/', () => {
    it('should create resource successfully', async () => {
      const response = await request(app)
        .post('/vehicles-refactored.example/')
  ...
  describe('PUT /vehicles-refactored.example/:id', () => {
    it('should update resource successfully', async () => {
      const response = await request(app)
        .put('/vehicles-refactored.example/:id')
    ...
    it('should return 404 for non-existent resource', async () => {
      const response = await request(app)
        .put('/vehicles-refactored.example/99999')
  ...
  describe('DELETE /vehicles-refactored.example/:id', () => {
    it('should delete resource successfully', async () => {
      const response = await request(app)
        .delete('/vehicles-refactored.example/:id')
    ...
    it('should return 404 for non-existent resource', async () => {
      const response = await request(app)
        .delete('/vehicles-refactored.example/99999')
  ...
  describe('Tenant Isolation', () => {
    it('should prevent cross-tenant data access', async () => {
      ...
      const responseB = await request(app)
        .get(`/vehicles-refactored.example/${resourceA.body.id}`)
  ...
  describe('Input Validation', () => {
    it('should prevent SQL injection', async () => {
      const response = await request(app)
        .get(`/vehicles-refactored.example?id=1' OR '1'='1`)
        .set('Authorization', `Bearer ${authToken}`)
        .expect(400);
    });
