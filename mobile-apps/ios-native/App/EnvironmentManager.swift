...
struct EnvironmentConfiguration {
    ...
    static func development() -> EnvironmentConfiguration {
        EnvironmentConfiguration(
            ...
            azureAppServiceName: "dcf-fleet-management-dev",
            azureResourceGroup: "fleet-management-dev-rg",
            firebaseProjectID: "dcf-fleet-development",
            firebaseDatabaseURL: "http://localhost:8080",
            firebaseStorageBucket: "dcf-fleet-development.appspot.com",
    ...
    static func staging() -> EnvironmentConfiguration {
        EnvironmentConfiguration(
            ...
            apiTimeout: 30,
            azureBaseURL: "https://dcf-fleet-management-staging.azurewebsites.net",
            azureAPIURL: "https://dcf-fleet-management-staging.azurewebsites.net/api",
            azureAppServiceName: "dcf-fleet-management-staging",
            azureResourceGroup: "fleet-management-staging-rg",
            firebaseProjectID: "dcf-fleet-staging",
            firebaseDatabaseURL: "https://dcf-fleet-staging.firebaseio.com",
            firebaseStorageBucket: "dcf-fleet-staging.appspot.com",
    ...
    static func production() -> EnvironmentConfiguration {
        EnvironmentConfiguration(
            ...
            apiTimeout: 30,
            azureBaseURL: "https://dcf-fleet-management.azurewebsites.net",
            azureAPIURL: "https://dcf-fleet-management.azurewebsites.net/api",
            azureAppServiceName: "dcf-fleet-management",
            azureResourceGroup: "fleet-management-rg",
            firebaseProjectID: "dcf-fleet-production",
            firebaseDatabaseURL: "https://dcf-fleet-production.firebaseio.com",
            firebaseStorageBucket: "dcf-fleet-production.appspot.com",
