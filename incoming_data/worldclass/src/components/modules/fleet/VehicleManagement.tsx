                            ...
                            <div style={{
                              ...
                              <div style={{display:'flex', flexDirection:'column', gap:10}}>
                                ...
                                <div style={{display:'flex', justifyContent:'space-between'}}>
                                  ...
                                  <span style={{fontSize:12, color:'#10b981', fontWeight:600}}>24.5 mpg</span>
                                </div>
                                <div style={{display:'flex', justifyContent:'space-between'}}>
                                  <span style={{fontSize:12, color:'var(--muted, #94a3b8)'}}>Last Service</span>
                                  <span style={{fontSize:12, color:'var(--text, #f1f5f9)', fontWeight:600}}>14 days ago</span>
                                </div>
                              </div>
                            </div>
