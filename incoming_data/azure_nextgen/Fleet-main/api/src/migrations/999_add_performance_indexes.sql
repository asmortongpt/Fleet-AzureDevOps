...
-- Filter indexes
CREATE INDEX IF NOT EXISTS idx_fuel_transactions_type ON fuel_transactions(fuel_type) WHERE fuel_type IS NOT NULL;
...
CREATE INDEX IF NOT EXISTS idx_incidents_safety_status ON incidents(status);
